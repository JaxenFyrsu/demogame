!(function (t, e) {
  ...
  var b,
    ...
    k = i(function t(e, r, i) {
      n(this, t), (this.length = e), (this.debugMetadata = r), (this.text = i);
    });
  !(function (t) {
    (t[(t.Author = 0)] = "Author"),
      ...
      function t() {
        ...
        n(this, t),
          ...
          (this.AddContent = function (t) {
            ...
            var n,
              r = S(Array.isArray(t) ? t : [t]);
            try {
              for (r.s(); !(n = r.n()).done; ) {
                var i = n.value;
                i.hasOwnProperty("parent") && (i.parent = e), e.content.push(i);
              }
            } catch (t) {
              r.e(t);
            } finally {
            ...
            return function () {
              var n =
                  arguments.length > 0 && void 0 !== arguments[0]
                    ...
                    : null,
                r = _(e, t);
              if (null !== r && (null === n || !0 === n(r))) return r;
              if (null === e.content) return null;
              var i,
                a = S(e.content);
              try {
                for (a.s(); !(i = a.n()).done; ) {
      ...
      return (
        i(t, [
          ...
          },
          {
            key: "runtimePath",
            get: function () {
              if (!this.runtimeObject.path) throw new Error();
          ...
          },
          {
            key: "ancestry",
            get: function () {
              for (var t = [], e = this.parent; e; ) t.push(e), (e = e.parent);
              return (t = t.reverse());
            },
          },
          {
          ...
          },
          {
            ...
            value: (function (t) {
              ...
              if (
                ...
                if (!this.parent)
                  throw new Error(
                    "No parent object to send error to: ".concat(t)
                  );
      ...
      function r(t) {
        ...
        return (
          ...
          (i.GenerateRuntimeObject = function () {
            return i.Warning(i.warningMessage), null;
          }),
          i
        );
      }
          ...
          [
            ...
            },
            {
              ...
              value: function (e) {
                for (
                  var n = new t(), r = 0, i = 0;
                  i < e._components.length && e._components[i].isParent;
                  ++i
                )
                  r++;
            ...
            },
            {
              ...
              set: function (e) {
                if (
                  ...
                  var n,
                    r = S(this._componentsString.split("."));
                  try {
                    for (r.s(); !(n = r.n()).done; ) {
                      var i = n.value;
                      /^(\-|\+)?([0-9]+|Infinity)$/.test(i)
                        ? this._components.push(new t.Component(parseInt(i)))
                        : this._components.push(new t.Component(i));
                    }
                  } catch (t) {
                    r.e(t);
                  } finally {
            ...
            },
            {
              ...
              value: function (e) {
                var n,
                  r = new t();
                return (
                  (n = r._components).push.apply(n, g(this._components)),
      ...
      return (
        i(t, [
            ...
            value: function (t) {
              ...
              if (e) {
                ...
                if (n) {
                  ...
                  if (null !== r) return r.startLineNumber;
                }
              }
              return null;
            },
          },
          {
            ...
            get: function () {
              if (null == this._path)
                if (null == this.parent) this._path = new R();
                else {
                  for (
                    var t = [], e = this, n = _(e.parent, tt);
                    null !== n;

                  ) {
                    var r = A(e);
                    if (null != r && r.hasValidName) {
                      if (null === r.name) return L("namedChild.name");
                      t.unshift(new R.Component(r.name));
                    } else t.unshift(new R.Component(n.content.indexOf(e)));
                    (e = n), (n = _(n.parent, tt));
                  }
                  this._path = new R(t);
                }
    ...
    B = (function () {
      function t() {
        if (
          ...
          var e = arguments[0],
            r = arguments[1];
          (this.originName = e), (this.itemName = r);
        } else if (arguments[0]) {
          var i = arguments[0],
            a = i.toString().split(".");
          (this.originName = a[0]), (this.itemName = a[1]);
        }
      }
      return (
        i(
    ...
    M = (function (t) {
      ...
      function o() {
        ...
        if (
          ...
          var l = arguments[0],
            u = arguments[1];
          if ((t.SetInitialOriginName(l), null === u.listDefinitions))
          ...
          if (null === c.result) return f(t, L("def.result"));
          t.origins = [c.result];
        } else if (
          ...
          [
            {
              ...
              value: function (t) {
                if (t instanceof B) {
                  ...
                  if (null === this.origins) return L("this.origins");
                  var n,
                    r = S(this.origins);
                  try {
                    for (r.s(); !(n = r.n()).done; ) {
            ...
            },
            {
              ...
              value: function (t) {
                ...
                try {
                  for (n.s(); !(e = n.n()).done; ) {
                    var r = m(e.value, 1)[0];
                    if (B.fromSerializedKey(r).itemName == t) return !0;
                  }
                } catch (t) {
                  n.e(t);
                } finally {
                ...
                if (this.Count > 0) {
                  ...
                  try {
                    for (e.s(); !(t = e.n()).done; ) {
                      ...
                      if (null === r.originName) return L("item.originName");
              ...
              get: function () {
                ...
                try {
                  for (n.s(); !(t = n.n()).done; ) {
                    ...
                    (e.Key.isNull || a > e.Value) && (e = { Key: o, Value: a });
                  }
                } catch (t) {
                  n.e(t);
                } finally {
            ...
            },
            {
              ...
              value: function (t, e) {
                if (0 == this.Count) return new o();
                var n = this.orderedItems,
                  r = 0,
                  i = Number.MAX_SAFE_INTEGER;
                Number.isInteger(t)
                  ? (r = t)
                  : t instanceof o && t.Count > 0 && (r = t.minItem.Value),
                  Number.isInteger(e)
                    ? (i = e)
                    : t instanceof o && t.Count > 0 && (i = e.maxItem.Value);
                var a = new o();
            ...
            },
            {
              ...
              value: function () {
                for (
                  var t = this.orderedItems, e = new j(), n = 0;
                  n < t.length;
                  n++
                ) {
                  n > 0 && e.Append(", ");
                  var r = t[n].Key;
                  if (null === r.itemName) return L("item.itemName");
                  e.Append(r.itemName);
                }
                return e.toString();
              },
  ...
  function q(t, e, n) {
    ...
    var r = t.get(e);
    return void 0 === r ? { result: n, exists: !1 } : { result: r, exists: !0 };
  }
  var U,
    K = (function (t) {
      a(r, t);
      ...
      function r(t) {
        var i;
        return n(this, r), ((i = e.call(this)).value = t), i;
      }
      return (
        i(r, [
          {
            ...
            [
              {
                ...
                value: function (t, e) {
                  if (e) {
                    ...
                    if (e === U.Float && !isNaN(t)) return new z(Number(t));
                  }
    ...
    H = (function (t) {
      ...
      var e = d(r);
      function r(t) {
        return n(this, r), e.call(this, t || !1);
      }
      return (
        i(r, [
          {
          ...
          },
          {
            key: "Cast",
            value: function (t) {
              if (null === this.value) return L("Value.value");
              if (t == this.valueType) return this;
              if (t == U.Int) return new J(this.value ? 1 : 0);
              if (t == U.Float) return new z(this.value ? 1 : 0);
              if (t == U.String) return new $(this.value ? "true" : "false");
    ...
    J = (function (t) {
      ...
      var e = d(r);
      function r(t) {
        return n(this, r), e.call(this, t || 0);
      }
      return (
        i(r, [
          {
          ...
          },
          {
            ...
            value: function (t) {
              if (null === this.value) return L("Value.value");
              if (t == this.valueType) return this;
              if (t == U.Bool) return new H(0 !== this.value);
              if (t == U.Float) return new z(this.value);
              if (t == U.String) return new $("" + this.value);
              throw this.BadCastException(t);
            },
          },
        ]),
        ...
        i(r, [
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (t == this.valueType) return this;
              if (t == U.Bool) return new H(0 !== this.value);
              if (t == U.Int) return new J(this.value);
              if (t == U.String) return new $("" + this.value);
              throw this.BadCastException(t);
            },
          },
      ...
      function r(t) {
        ...
        return (
          ...
          null === i.value
            ? f(i, L("Value.value"))
            : (i.value.length > 0 &&
                i.value.split("").every(function (t) {
                  return (
                    " " == t || "\t" == t || ((i._isInlineWhitespace = !1), !1)
                  );
                }),
              i)
        );
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (t == U.Int) {
                ...
                if (e.exists) return new J(e.result);
                throw this.BadCastException(t);
              }
              if (t == U.Float) {
                var n = (function (t) {
                ...
                if (n.exists) return new z(n.result);
                throw this.BadCastException(t);
              }
              throw this.BadCastException(t);
            },
    ...
    Y = (function (t) {
      ...
      function r(t) {
        ...
        return n(this, r), ((i = e.call(this, t))._contextIndex = a), i;
      }
      return (
        i(r, [
          {
        ...
        i(r, [
          ...
          },
          {
            ...
            get: function () {
              var t = 0;
              return (
                this.visitsShouldBeCounted && (t |= r.CountFlags.Visits),
            ...
            set: function (t) {
              var e = t;
              (e & r.CountFlags.Visits) > 0 &&
                (this.visitsShouldBeCounted = !0),
                (e & r.CountFlags.Turns) > 0 &&
                  (this.turnIndexShouldBeCounted = !0),
                (e & r.CountFlags.CountStartOnly) > 0 &&
          ...
          },
          {
            ...
            get: function () {
              for (var t = [], e = this; e instanceof r; )
                e.content.length > 0 &&
                  (t.push(new R.Component(0)), (e = e.content[0]));
              return new R(t);
            },
          },
          {
            ...
            value: function (t) {
              if (t instanceof Array) {
                ...
                var i = t;
                if ((this._content.push(i), i.parent))
                  throw new Error("content is already in " + i.parent);
                (i.parent = this), this.TryAddNamedContent(i);
              }
            },
          },
          {
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (null === t.name) return L("component.name");
              ...
              if (u.size > 0) {
                ...
                try {
                  for (p.s(); !(v = p.n()).done; ) {
                    ...
                    var C = y;
                    C.BuildStringOfHierarchy(t, e, n), t.AppendLine();
                  }
                } catch (t) {
                  p.e(t);
                } finally {
    ...
    function r() {
      var t,
        i =
          arguments.length > 0 && void 0 !== arguments[0]
            ? arguments[0]
            : r.CommandType.NotSet;
      return n(this, r), ((t = e.call(this))._commandType = i), t;
    }
    return (
      i(
        r,
  ...
  var nt = (function (t) {
      ...
      function r() {
        ...
        return (
          n(this, r),
          ((t = e.apply(this, arguments))._prototypeRuntimeConstantExpression =
            null),
          (t.outputWhenComplete = !1),
          (t.GenerateRuntimeObject = function () {
            var e = new tt();
            return (
              e.AddContent(et.EvalStart()),
          ...
          (t.GenerateConstantIntoContainer = function (e) {
            null === t._prototypeRuntimeConstantExpression &&
              ((t._prototypeRuntimeConstantExpression = new tt()),
              t.GenerateIntoContainer(t._prototypeRuntimeConstantExpression));
            var n,
              r = S(t._prototypeRuntimeConstantExpression.content);
            try {
              for (r.s(); !(n = r.n()).done; ) {
                var i = n.value.Copy();
                i && e.AddContent(i);
    ...
    it = (function (t) {
      ...
      function r() {
        ...
        if (
          ...
          var i = arguments[0];
          r.GenerateNativeFunctionsIfNecessary(), (t.name = i);
        } else if (2 === arguments.length) {
          var a = arguments[0],
            o = arguments[1];
          (t._isPrototype = !0), (t.name = a), (t.numberOfParameters = o);
        }
        return t;
      }
      return (
          ...
          [
            {
              ...
              get: function () {
                return null === this._name
                  ? L("NativeFunctionCall._name")
                  : this._name;
              },
              set: function (t) {
                (this._name = t),
                  this._isPrototype ||
                    (null === r._nativeFunctions
                      ? L("NativeFunctionCall._nativeFunctions")
                      : (this._prototype =
                          r._nativeFunctions.get(this._name) || null));
              },
            },
            {
              ...
              value: function (t) {
                ...
                if (2 == a || 1 == a) {
                  ...
                  if (!o) {
                    var s = U[n];
                    throw new G(
                      "Cannot perform operation " + this.name + " on " + s
                    );
                  }
                  if (2 == a) {
                    var l = T(t[1], K),
                  ...
                  var f = h(i.value);
                  return this.name === r.Int
                    ? K.Create(f, U.Int)
                    : this.name === r.Float
                    ? K.Create(f, U.Float)
                    : K.Create(f, e.valueType);
                }
                throw new Error(
            ...
            },
            {
              ...
              value: function (t) {
                ...
                if (
                  !(
                    ("&&" != this.name && "||" != this.name) ||
                    (e.valueType == U.List && n.valueType == U.List)
                  )
                ) {
                  if (null === this._operationFuncs)
                    return L("NativeFunctionCall._operationFuncs");
              ...
              value: function (t) {
                ...
                if (U[n] == U[U.List]) {
                  ...
                  try {
                    for (l.s(); !(s = l.n()).done; ) {
                      var u = T(s.value, K);
                      if (u.valueType == U.List) o.push(u);
                      else {
          ...
          [
            ...
            },
            {
              ...
              value: function (t, e, n, i) {
                ...
                a || ((a = new r(t, e)), this._nativeFunctions.set(t, a)),
      ...
      function r(t, i) {
        ...
        if (
          ...
          (a.GenerateIntoContainer = function (t) {
            a.isInt()
              ? t.AddContent(new J(a.value))
              : a.isFloat()
              ? t.AddContent(new z(a.value))
              : a.isBool() && t.AddContent(new H(a.value));
          }),
          (a.toString = function () {
        ...
        return (a.value = t), (a.subtype = i), a;
      }
      return (
        i(r, [
          {
  ...
  ot.WithInner = function (t, e) {
    ...
    if (n) {
      if ("-" === e) {
        if (n.isInt()) return new at(-n.value, "int");
        if (n.isFloat()) return new at(-n.value, "float");
      } else if ("!" == e || "not" == e) {
        if (n.isInt()) return new at(0 == n.value, "bool");
        if (n.isFloat()) return new at(0 == n.value, "bool");
        if (n.isBool()) return new at(!n.value, "bool");
      }
  ...
  var st = (function (t) {
      ...
      function r(t, i, a) {
        ...
        return (
          ...
          (o.toString = function () {
            return "("
              .concat(o.leftExpression, " ")
              .concat(o.opName, " ")
              .concat(o.rightExpression, ")");
          }),
            ...
            value: function (t) {
              if (
                ...
                null === e ||
                  ("not" !== e.op && "!" !== e.op) ||
                  this.Error(
                    "Using 'not' or '!' here negates '".concat(
                      e.innerExpression,
      ...
      if (
        ...
        (this.ToCharacterSet = function () {
          if (0 === i._correspondingCharSet.set.size)
            for (
              var t = i.start.charCodeAt(0), e = String.fromCharCode(t);
              t <= i.end.charCodeAt(0);
              t += 1
            )
    ...
    vt = (function (t) {
      ...
      function r(t) {
        ...
        return (
          ...
          (i.isConditional = !1),
          (i.pushesToStack = !1),
          void 0 !== t && ((i.pushesToStack = !0), (i.stackPushType = t)),
          i
        );
      }
      return (
        i(r, [
          {
            ...
            set: function (t) {
              (this._targetPath = t), (this._targetPointer = dt.Null);
            },
          },
          {
            key: "targetPointer",
            get: function () {
              if (this._targetPointer.isNull) {
                ...
                if (null === this._targetPath) return L("this._targetPath");
                if (null === this._targetPath.lastComponent)
                  return L("this._targetPath.lastComponent");
                if (this._targetPath.lastComponent.isIndex) {
                  if (null === t) return L("targetObj");
                  (this._targetPointer.container =
                    t.parent instanceof tt ? t.parent : null),
          ...
          },
          {
            ...
            value: function () {
              ...
              return (
                ...
                this.pushesToStack &&
                  (this.stackPushType == ct.Function
                    ? t.Append(" function")
                    : t.Append(" tunnel")),
                t.Append(" -> "),
      ...
      function r(t, i, a) {
        ...
        return (
          ...
          (o.GenerateRuntimeObject = function () {
            if (
              ((o._outerContainer = new tt()),
              (o._runtimeChoice = new ht(o.onceOnly)),
              (o._runtimeChoice.isInvisibleDefault = o.isInvisibleDefault),
              (o.startContent || o.choiceOnlyContent || o.condition) &&
                o._outerContainer.AddContent(et.EvalStart()),
              o.startContent)
            ) {
              (o._returnToR1 = new X()),
            ...
            if (
              (o.condition &&
                (o.condition.GenerateIntoContainer(o._outerContainer),
                (o._runtimeChoice.hasCondition = !0)),
              (o.startContent || o.choiceOnlyContent || o.condition) &&
                o._outerContainer.AddContent(et.EvalEnd()),
              ...
              o._innerContentContainer.AddContent(r),
                ...
                o._innerContentContainer.AddContent(
                  o._divertToStartContentInner
                ),
                (o._r2Label = new tt()),
                (o._r2Label.name = "$r2"),
            ...
            return (
              o.story.countAllVisits &&
                (o._innerContentContainer.visitsShouldBeCounted = !0),
              (o._innerContentContainer.countingAtStartOnly = !0),
              o._outerContainer
            );
          }),
          (o.toString = function () {
            return null !== o.choiceOnlyContent
              ? "* "
                  .concat(o.startContent, "[")
                  .concat(o.choiceOnlyContent, "]...")
              : "* ".concat(o.startContent, "...");
          }),
          (o.startContent = t),
        ...
        i(r, [
          {
            key: "runtimeChoice",
            get: function () {
              if (!this._runtimeChoice) throw new Error();
          ...
          },
          {
            ...
            get: function () {
              var t;
              return (
                (null === (t = this.identifier) || void 0 === t
                  ? void 0
                  : t.name) || null
              );
            },
          },
          {
            ...
            set: function (t) {
              (this._condition = t), t && this.AddContent(t);
            },
          },
          {
          ...
          },
          {
            ...
            get: function () {
              if (
                ...
                !this.innerContentContainer.path
              )
                throw new Error();
            ...
            value: function (t) {
              ...
              if (
                (this._innerContentContainer &&
                  ((this.runtimeChoice.pathOnChoice =
                    this._innerContentContainer.path),
                  this.onceOnly &&
                    (this._innerContentContainer.visitsShouldBeCounted = !0)),
                this._returnToR1)
              ) {
                if (!this._r1Label) throw new Error();
                this._returnToR1.targetPath = this._r1Label.path;
              }
              if (this._returnToR2) {
                if (!this._r2Label) throw new Error();
                this._returnToR2.targetPath = this._r2Label.path;
              }
              if (this._divertToStartContentOuter) {
                if (!this._startContentRuntimeContainer) throw new Error();
              ...
              p(o(r.prototype), "ResolveReferences", this).call(this, t),
                this.identifier &&
                  (
                    (null === (e = this.identifier) || void 0 === e
                      ? void 0
                      : e.name) || ""
                  ).length > 0 &&
                  t.CheckForNamingCollisions(
                    this,
                    this.identifier,
                    ft.SubFlowAndWeave
                  );
      ...
      function t() {
        ...
        n(this, t),
          ...
          (this.StringParserState = function () {
            ...
            for (var t = 0; t < 200; ++t) e._stack[t] = new gt();
            e._numElements = 1;
          }),
          (this.Push = function () {
            ...
            return e._numElements++, n.CopyFrom(t), n.uniqueId;
          }),
          (this.Pop = function (t) {
            if (1 == e._numElements)
              throw new Error(
          ...
          (this.Squash = function () {
            ...
            t.SquashFrom(n), (e._numElements -= 1);
          }),
        ...
        for (var r = 0; r < 200; r++) this._stack[r] = new gt();
        this._numElements = 1;
      }
      return (
        i(t, [
      ...
      function t(e) {
        ...
        n(this, t),
          ...
          (this.SucceedRule = function (e) {
            ...
            r.RuleDidSucceed && r.RuleDidSucceed(n, a, i), r.state.Squash();
            var o = n;
            return null === o && (o = t.ParseSuccess), o;
          }),
          ...
          (this.ErrorWithParsedObject = function (t, e) {
            ...
            r.ErrorOnLine(
              t,
              e.debugMetadata ? e.debugMetadata.startLineNumber : -1,
              n
            );
          }),
          (this.ErrorOnLine = function (t, e, n) {
            if (!r.state.errorReportedAlreadyInScope) {
              ...
              if (!r.errorHandler)
                throw new Error(
                  "".concat(i, " on line ").concat(e, ": ").concat(t)
                );
              r.errorHandler(t, r.index, e - 1, n), r.state.NoteErrorReported();
            }
            n || (r.hadError = !0);
          }),
          (this.Warning = function (t) {
          ...
          (this.ParseObject = function (t) {
            ...
            return null === i ? r.FailRule(e) : (r.SucceedRule(e, i), i);
          }),
          ...
          (this.Interleave = function (e, n) {
            var i =
              ...
              s = [],
              l = r.ParseObject(e);
            if (null === l) return r.FailRule(o);
            r.TryAddResultToList(l, s, a);
            var u = null,
              c = null;
            do {
              if (null !== i && null !== r.Peek(i)) break;
              if (null === (u = r.ParseObject(n))) break;
              if ((r.TryAddResultToList(u, s, a), (c = null), null !== u)) {
                if (null === (c = r.ParseObject(e))) break;
                r.TryAddResultToList(c, s, a);
              }
            } while (
              (null !== u || null !== c) &&
              (u !== t.ParseSuccess || c != t.ParseSuccess) &&
              r.remainingLength > 0
            );
            return 0 === s.length ? r.FailRule(o) : r.SucceedRule(o, s);
          }),
          (this.ParseString = function (t) {
            if (t.length > r.remainingLength) return null;
            for (
              var e = r.BeginRule(),
                n = r.index,
                i = r.characterInLineIndex,
                a = r.lineIndex,
                o = !0,
                s = 0;
              s < t.length;
          ...
          (this.ParseSingleCharacter = function () {
            if (r.remainingLength > 0) {
              ...
              return (
                "\n" === t &&
                  ((r.lineIndex += 1), (r.characterInLineIndex = -1)),
                (r.index += 1),
          ...
          (this.ParseCharactersFromString = function (t) {
            ...
            return "number" == typeof e
              ? r.ParseCharactersFromCharSet(i, !0, e)
              : r.ParseCharactersFromCharSet(i, e, n);
          }),
          (this.ParseCharactersFromCharSet = function (t) {
            ...
            for (
              var i = r.index,
                a = r.index,
                o = r.characterInLineIndex,
                s = r.lineIndex,
                l = 0;
              a < r._chars.length && t.set.has(r._chars[a]) === e && l < n;
              ...
              "\n" === r._chars[a] && ((s += 1), (o = -1)),
                ...
                (o += 1),
                (l += 1);
            (r.index = a), (r.characterInLineIndex = o), (r.lineIndex = s);
            var u = r.index;
          ...
          (this.ParseInt = function () {
            ...
            var a,
              o = r.ParseCharactersFromCharSet(t.numbersCharacterSet);
            return null === o
              ? ((r.index = e), (r.characterInLineIndex = n), null)
          ...
          (this.ParseFloat = function () {
            ...
            return (r.index = e), (r.characterInLineIndex = n), null;
          }),
        ...
        i(t, [
          {
            ...
            get: function () {
              return this.index >= 0 && this.remainingLength > 0
                ? this._chars[this.index]
                : "0";
            },
          },
          {
          ...
          },
          {
            ...
            value: function (t) {
              ...
              null !== e &&
                (i.set = new Set(
                  [].concat(g(i.set.values()), g(e.set.values()))
                )),
                null !== n &&
                  (i.set = new Set(
                    [].concat(g(i.set.values()), g(n.set.values()))
                  ));
              for (var a = ""; ; ) {
                var o = this.ParseUntilCharactersFromCharSet(i);
                if ((o && (a += o), null !== this.Peek(t))) break;
                if (this.endOfInput) break;
                var s = this.currentCharacter;
                if (null === e || !e.set.has(s)) break;
                (a += s),
                  "\n" === s &&
                    ((this.lineIndex += 1), (this.characterInLineIndex = -1)),
                  (this.index += 1),
                  (this.characterInLineIndex += 1);
              }
              return a.length > 0
                ? this.SucceedRule(r, String(a))
                : this.FailRule(r);
            },
          },
        ]),
  ...
  (St.ParseSuccess = Ct), (St.numbersCharacterSet = new lt("0123456789"));
  var bt,
    wt = (function (t) {
      a(r, t);
      var e = d(r);
      function r() {
        ...
        return (
          n(this, r),
          ((t = e.apply(this, arguments))._commentOrNewlineStartCharacter =
            new lt("/\r\n")),
          (t._commentBlockEndCharacter = new lt("*")),
          (t._newlineCharacters = new lt("\n\r")),
          (t.Process = function () {
            var e = t.Interleave(
              t.Optional(t.CommentsAndNewlines),
              t.Optional(t.MainInk)
            );
            return null !== e ? e.join("") : "";
          }),
          (t.MainInk = function () {
            return t.ParseUntil(
              t.CommentsAndNewlines,
              t._commentOrNewlineStartCharacter,
              null
            );
          }),
          (t.CommentsAndNewlines = function () {
            var e = t.Interleave(
              t.Optional(t.ParseNewline),
              t.Optional(t.ParseSingleComment)
            );
          ...
          (t.EndOfLineComment = function () {
            return null === t.ParseString("//")
              ? null
              : (t.ParseUntilCharactersFromCharSet(t._newlineCharacters), "");
          }),
          (t.BlockComment = function () {
            if (null === t.ParseString("/*")) return null;
            var e = t.lineIndex,
              n = t.ParseUntil(
                t.String("*/"),
                t._commentBlockEndCharacter,
                null
              );
            return (
              t.endOfInput || t.ParseString("*/"),
      ...
      function r(t, i) {
        ...
        return (
          ...
          (a.GenerateRuntimeObject = function () {
            var t = new tt();
            a.initialCondition &&
              t.AddContent(a.initialCondition.runtimeObject);
            var e,
              n = S(a.branches);
            try {
              for (n.s(); !(e = n.n()).done; ) {
            ...
            return (
              null === a.initialCondition ||
                null === a.branches[0].ownExpression ||
                a.branches[a.branches.length - 1].isElse ||
                t.AddContent(et.PopEvaluatedValue()),
      ...
      return (
        i(r, [
          ...
          },
          {
            ...
            value: function (t) {
              var e,
                n = this._reJoinTarget.path,
                i = S(this.branches);
              try {
                for (i.s(); !(e = i.n()).done; ) {
                  var a = e.value;
                  if (!a.returnDivert) throw new Error();
        ...
        i(r, [
          {
            ...
            get: function () {
              var t;
              return null === (t = this.constantIdentifier) || void 0 === t
                ? void 0
                : t.name;
            },
          },
          {
            key: "expression",
            get: function () {
              if (!this._expression) throw new Error();
      ...
      function r(t, i) {
        ...
        return (
          ...
          (a.toString = function () {
            var t, e;
            return "- ".concat(
              (null === (t = a.identifier) || void 0 === t ? void 0 : t.name)
                ? "(" +
                    (null === (e = a.identifier) || void 0 === e
                      ? void 0
                      : e.name) +
                    ")"
                : "gather"
      ...
      function t(e, r) {
        ...
        n(this, t),
          ...
          (this.toString = function () {
            return null === i.components || 0 === i.components.length
              ? i.baseTargetLevel === bt.WeavePoint
                ? "-> <next gather point>"
                : "<invalid Path>"
              : "-> ".concat(i.dotSeparatedComponents);
          }),
          (this.ResolveFromContext = function (t) {
            if (null == i.components || 0 == i.components.length) return null;
            var e = i.ResolveBaseTarget(t);
            return null === e
              ? null
              : i.components.length > 1
              ? i.ResolveTailComponents(e)
              : e;
          }),
          ...
          (this.ResolveTailComponents = function (t) {
            ...
            for (var n = 1; n < i.components.length; ++n) {
              var r = i.components[n].name,
                ...
                o = _(e, Ot);
              if (
                ((a = null !== o ? o.flowLevel + 1 : bt.WeavePoint),
          ...
          Object.values(bt).includes(e)
            ? ((this._baseTargetLevel = e), (this.components = r || []))
            : Array.isArray(e)
            ? ((this._baseTargetLevel = null), (this.components = e || []))
            : ((this._baseTargetLevel = null), (this.components = [e]));
      }
      return (
        i(t, [
          {
            key: "baseTargetLevel",
            get: function () {
              return this.baseLevelIsAmbiguous
                ? bt.Story
                : this._baseTargetLevel;
            },
          },
          {
          ...
          },
          {
            key: "firstComponent",
            get: function () {
              return null != this.components && this.components.length
          ...
          },
          {
            ...
            get: function () {
              return (
                null == this._dotSeparatedComponents &&
      ...
      function r() {
        ...
        return (
          ...
          (t.GenerateRuntimeObject = function () {
            var e = new tt();
            return (
              t.returnedExpression
                ? e.AddContent(t.returnedExpression.runtimeObject)
                : (e.AddContent(et.EvalStart()),
                  e.AddContent(new rt()),
                  e.AddContent(et.EvalEnd())),
  ...
  function Nt(t) {
    for (var e = t.parent; e; ) {
      if (e.hasOwnProperty("iamFlowbase") && e.iamFlowbase()) return e;
      e = e.parent;
    }
    return null;
  }
    ...
    Ot = (function (t) {
      ...
      function r(t) {
        ...
        return (
          ...
          (i.SplitWeaveAndSubFlowContent = function (t, e) {
            ...
            try {
              for (u.s(); !(l = u.n()).done; ) {
                var c = l.value,
                  h = _(c, r);
                h
                  ? (null === i._firstChildFlow && (i._firstChildFlow = h),
                    s.push(c),
                    (null === (n = h.identifier) || void 0 === n
                      ? void 0
                      : n.name) &&
                      i._subFlowsByName.set(
                        null === (a = h.identifier) || void 0 === a
                          ? void 0
                          : a.name,
                        h
                      ))
            ...
            return (
              o.length > 0 &&
                ((i._rootWeave = new zt(o, 0)), f.push(i._rootWeave)),
            ...
            if (a) {
              if (null !== a.args) {
                ...
                try {
                  for (s.s(); !(o = s.n()).done; ) {
                    if (
                      (null === (n = o.value.identifier) || void 0 === n
                        ? void 0
                        : n.name) === t
                    )
                      return (
              ...
              if (a !== i.story && a.variableDeclarations.has(t))
                return (
                  (r.found = !0), (r.ownerFlow = a), (r.isTemporary = !0), r
                );
            }
            return i.story.variableDeclarations.has(t)
              ? ((r.found = !0), (r.ownerFlow = i.story), (r.isGlobal = !0), r)
              : ((r.found = !1), r);
          }),
          (i.AddNewVariableDeclaration = function (t) {
            ...
            if (i.variableDeclarations.has(e)) {
              var n = i.variableDeclarations.get(e),
                r = "";
              return (
                n.debugMetadata && (r = " (".concat(n.debugMetadata, ")")),
                void i.Error(
                  "found declaration variable '"
                    .concat(e, "' that was already declared")
                    .concat(r),
                  t,
                  !1
                )
          ...
          (i.ResolveWeavePointNaming = function () {
            ...
            var t,
              e = S(i._subFlowsByName);
            try {
              for (e.s(); !(t = e.n()).done; ) {
                var n = m(t.value, 2)[1];
                n.hasOwnProperty("ResolveWeavePointNaming") &&
                  n.ResolveWeavePointNaming();
              }
            } catch (t) {
              e.e(t);
            } finally {
          ...
          (i.GenerateRuntimeObject = function () {
            var t,
              e = null;
            i.isFunction
              ? i.CheckForDisallowedFunctionFlowControl()
              : (i.flowLevel !== bt.Knot && i.flowLevel !== bt.Stitch) ||
                (null !== (e = i.Find(Pt)()) &&
                  i.Error(
                    "Return statements can only be used in knots that are declared as functions: == function ".concat(
                      i.identifier,
                      " =="
                    ),
                    e
            ...
            var n = new tt();
            (n.name =
              null === (t = i.identifier) || void 0 === t ? void 0 : t.name),
            ...
            for (var a = 0; null !== i.content && a < i.content.length; ) {
              ...
              if (o instanceof r) {
                ...
                0 !== a ||
                  s.hasParameters ||
                  i.flowLevel !== bt.Knot ||
                  ((i._startingSubFlowDivert = new vt()),
                ...
                if (c) {
                  var h = ""
                    .concat(i.GetType(), " already contains flow named '")
                    .concat(u.name, "' (at ")
                    .concat(c.debugMetadata, ")");
                  i.Error(h, s);
                }
                n.AddToNamedContentOnly(u);
              } else o && n.AddContent(o.runtimeObject);
              a += 1;
            }
            return (
              i.flowLevel === bt.Story ||
                i.isFunction ||
                null === i._rootWeave ||
                null !== e ||
                i._rootWeave.ValidateTermination(i.WarningInTermination),
              n
            );
          }),
          (i.GenerateArgumentVariableAssignments = function (t) {
            ...
            if (null !== i.args && 0 !== i.args.length)
              for (var n = i.args.length - 1; n >= 0; --n) {
                var r =
                    (null === (e = i.args[n].identifier) || void 0 === e
                      ? void 0
                      : e.name) || null,
                  a = new pt(r, !0);
                t.AddContent(a);
          ...
          (i.ContentWithNameAtLevel = function (t) {
            var e,
              ...
              r =
                arguments.length > 2 && void 0 !== arguments[2] && arguments[2];
            if (
              (n === i.flowLevel || null === n) &&
              t ===
                (null === (e = i.identifier) || void 0 === e ? void 0 : e.name)
            )
              return h(i);
            ...
            if (null !== n && n < i.flowLevel) return null;
            var o = i._subFlowsByName.get(t) || null;
            return !o || (null !== n && n !== o.flowLevel)
              ? r
                ? i.DeepSearchForAnyLevelContent(t)
                : null
              : o;
          }),
          ...
          (i.CheckForDisallowedFunctionFlowControl = function () {
            ...
            try {
              for (e.s(); !(t = e.n()).done; ) {
                var n = m(t.value, 2),
                  ...
                  a = n[1];
                i.Error(
                  "Functions may not contain stitches, but saw '"
                    .concat(r, "' within the function '")
                    .concat(i.identifier, "'"),
                  a
                );
              }
            ...
            if (!i._rootWeave) throw new Error();
            var o,
              s = S(i._rootWeave.FindAll(jt)());
            try {
              for (s.s(); !(o = s.n()).done; ) {
                var l = o.value;
                l.isFunctionCall ||
                  l.parent instanceof Vt ||
                  i.Error(
                    "Functions may not contain diverts, but saw '".concat(
                      l,
                      "'"
                    ),
                    l
            ...
            var u,
              c = S(i._rootWeave.FindAll(mt)());
            try {
              for (c.s(); !(u = c.n()).done; ) {
                var h = u.value;
                i.Error(
                  "Functions may not contain choices, but saw '".concat(h, "'"),
                  h
                );
              }
            } catch (t) {
          ...
          (i.WarningInTermination = function (t) {
            ...
            t.parent === i._rootWeave &&
              i._firstChildFlow &&
              (e = ""
                .concat(e, " Note that if you intend to enter '")
                .concat(
                  i._firstChildFlow.identifier,
                  "' next, you need to divert to it explicitly."
                ));
            var n = _(t, jt);
            n &&
              n.isTunnel &&
              (e += " When final tunnel to '".concat(
                n.target,
      ...
      return (
        i(r, [
          ...
          { key: "PreProcessTopLevelObjects", value: function (t) {} },
          {
            key: "ResolveReferences",
            value: function (t) {
              var e, n;
              if (this._startingSubFlowDivert) {
                if (!this._startingSubFlowRuntime) throw new Error();
              ...
              if (
                ...
                for (var l = 0; l < this.args.length; l += 1)
                  for (var u = l + 1; u < this.args.length; u += 1)
                    (null === (e = this.args[l].identifier) || void 0 === e
                      ? void 0
                      : e.name) ==
                      (null === (n = this.args[u].identifier) || void 0 === n
                        ? void 0
                        : n.name) &&
                      this.Error(
                        "Multiple arguments with the same name: '".concat(
                          this.args[l].identifier,
                          "'"
                        )
                      );
              }
              if (this.flowLevel !== bt.Story) {
                var c =
                  this.flowLevel === bt.Knot ? ft.Knot : ft.SubFlowAndWeave;
        ...
        n(this, r),
          ...
          (i.TrimTrailingWhitespace = function () {
            for (var t = i.content.length - 1; t >= 0; --t) {
              ...
              if (null === e) break;
              if (
                ((e.text = e.text.replace(new RegExp(/[ \t]/g), "")),
                0 !== e.text.length)
              )
                break;
          ...
          (i.GenerateRuntimeObject = function () {
            ...
            return i.dontFlatten && i.story.DontFlattenContainer(t), t;
          }),
          (i.toString = function () {
        ...
        var t,
          i =
            arguments.length > 0 && void 0 !== arguments[0]
              ...
              : null;
        return (
          n(this, r), ((t = e.call(this)).pathForCount = null), (t.name = i), t
        );
      }
      return (
        i(r, [
      ...
      function r(t) {
        ...
        return (
          ...
          (i.GenerateIntoContainer = function (t) {
            ...
            if (e)
              return (
                e.GenerateConstantIntoContainer(t),
                void (i.isConstantReference = !0)
              );
            if (
              ((i._runtimeVarRef = new Ft(i.name)),
              ...
              1 === i.path.length
                ? (n = i.path[0])
                : ((r = i.path[0]), (n = i.path[1])),
                i.story.ResolveListItem(r, n, h(i)) &&
                  (i.isListItemReference = !0);
            }
          ...
          },
          {
            ...
            value: function (t) {
              if (
                ...
                if (n) {
                  if (!n.containerForCounting) throw new Error();
                  if (
                    ((n.containerForCounting.visitsShouldBeCounted = !0),
                  ...
                  i &&
                    i.isFunction &&
                    (this.parent instanceof zt ||
                      this.parent instanceof It ||
                      this.parent instanceof Ot) &&
                    this.Warning(
                      "'"
                        .concat(
                          i.identifier,
                  ...
                  if (this.path.length > 1) {
                    ...
                    return (
                      this.path.length <= 2 &&
                        (a +=
                          ", or couldn't find list item with the name ".concat(
                            this.path.join(",")
                          )),
                      void this.Error(a)
                    );
                  }
                  t.ResolveVariableWithName(this.name, this).found ||
        ...
        return (
          ...
          (a.GenerateIntoContainer = function (t) {
            ...
            if (a.isChoiceCount)
              ...
              a.args.length > 0 &&
                a.Error("The TURNS() function shouldn't take any arguments"),
              ...
              r
                ? ((a._divertTargetToCount = r),
                  a.AddContent(a._divertTargetToCount),
                  a._divertTargetToCount.GenerateIntoContainer(t))
                : i &&
                  ((a._variableReferenceToCount = i),
                  a.AddContent(a._variableReferenceToCount),
                  a._variableReferenceToCount.GenerateIntoContainer(t)),
                a.isTurnsSince
                  ? t.AddContent(et.TurnsSince())
                  : t.AddContent(et.ReadCount());
            } else if (a.isRandom) {
              2 !== a.args.length &&
                a.Error(
              ...
              for (var o = 0; o < a.args.length; o += 1) {
                ...
                if (s && !s.isInt()) {
                  ...
                  a.Error(
                    "RANDOM's ".concat(l, " parameter should be an integer")
                  );
                }
              ...
              u &&
                !u.isInt() &&
                a.Error("SEED_RANDOM's parameter should be an integer seed"),
              ...
              1 !== a.args.length &&
                a.Error("LIST_RANDOM should take 1 parameter - a list"),
                a.args[0].GenerateIntoContainer(t),
              ...
              if (h.numberOfParameters !== a.args.length) {
                var f = ""
                  .concat(name, " should take ")
                  .concat(h.numberOfParameters, " parameter");
                h.numberOfParameters > 1 && (f += "s"), a.Error(f);
              }
              ...
              if (
                ...
                var v = new M();
                v.SetInitialOriginName(a.name), t.AddContent(new Z(v));
              }
            else t.AddContent(a._proxyDivert.runtimeObject), (n = !0);
              ...
              if (this._divertTargetToCount) {
                ...
                if (a)
                  return void this.Error(
                    "When getting the TURNS_SINCE() of a variable target, remove the '->' - i.e. it should just be TURNS_SINCE(".concat(
                      i.runtimeDivert.variableDivertName,
                      ")"
                    )
                  );
                ...
                if (null === s)
                  a ||
                    this.Error(
                      "Failed to find target for TURNS_SINCE: '".concat(
                        i.target,
                        "'"
                      )
                    );
                else {
                  if (!s.containerForCounting) throw new Error();
  ...
  var Dt,
      ...
      function r(t) {
        ...
        return (
          ...
          (i.Equals = function (t) {
            var e = _(t, r);
            return (
              !!(e && i.divert.target && e.divert.target) &&
              i.divert.target.dotSeparatedComponents ===
                e.divert.target.dotSeparatedComponents
            );
          }),
        ...
        i(r, [
          {
            key: "runtimeDivert",
            get: function () {
              if (!this._runtimeDivert) throw new Error();
          ...
          },
          {
            ...
            get: function () {
              if (!this._runtimeDivertTargetValue) throw new Error();
              ...
              if (
                ...
                for (var e = this; e && e instanceof nt; ) {
                  ...
                  if (a instanceof st) {
                    ...
                    "==" !== s.opName && "!=" !== s.opName
                      ? (n = !0)
                      : ((s.leftExpression instanceof r ||
                          s.leftExpression instanceof Wt) &&
                          (s.rightExpression instanceof r ||
                            s.rightExpression instanceof Wt)) ||
                        (n = !0),
                      (i = !0);
                  } else if (a instanceof Rt) {
                    var l = a;
                    l.isTurnsSince || l.isReadCount || (n = !0), (i = !0);
                  } else
                    (a instanceof nt ||
                      a instanceof Lt ||
                      (a instanceof mt && a.condition === e) ||
                      a instanceof kt ||
                      a instanceof $t) &&
                      ((n = !0), (i = !0));
                  if (
                    (n &&
                      this.Error(
                        "Can't use a divert target like that. Did you intend to call '".concat(
                          this.divert.target,
                ...
                if (this.runtimeDivert.hasVariableTarget) {
                  if (!this.divert.target) throw new Error();
                  this.Error(
                    "Since '".concat(
                      this.divert.target.dotSeparatedComponents,
    ...
    jt = (function (t) {
      ...
      function r(t, i) {
        ...
        return (
          ...
          (a.isThread = !1),
          (a.GenerateRuntimeObject = function () {
            if (a.isEnd) return et.End();
            if (a.isDone) return et.Done();
            ...
            if (t || a.isFunctionCall || a.isTunnel || a.isThread) {
              ...
              if (t) {
                ...
                for (var r = 0; r < a.args.length; ++r) {
                  var i = a.args[r],
                    o = null;
                  if ((n && r < n.length && (o = n[r]), o && o.isByReference)) {
                    var s = _(i, Wt);
                    if (!s) {
                      a.Error(
                        "Expected variable name to pass by reference to 'ref "
                          .concat(o.identifier, "' but saw ")
                          .concat(i)
                      );
                      break;
                    }
                    ...
                    if (l.ResolveFromContext(h(a))) {
                      a.Error(
                        "can't pass a read count by reference. '"
                          .concat(
                            l.dotSeparatedComponents,
                            "' is a knot/stitch/label, but '"
                          )
                          .concat(
                            a.target.dotSeparatedComponents,
                    ...
                    var u = new Y(s.name);
                    e.AddContent(u);
                  } else i.GenerateIntoContainer(e);
                }
                a.isFunctionCall || e.AddContent(et.EvalEnd());
              }
              return (
                a.isThread
                  ? e.AddContent(et.StartThread())
                  : (a.isFunctionCall || a.isTunnel) &&
                    ((a.runtimeDivert.pushesToStack = !0),
                    (a.runtimeDivert.stackPushType = a.isFunctionCall
                      ? ct.Function
                      : ct.Tunnel)),
                      ...
                      r &&
                        ...
                        a.Error(
                          "Since '"
                            .concat(
                              r.identifier,
                              "' is used as a variable divert target (on "
                            )
                            .concat(
                              a.debugMetadata,
          ...
          (a.CheckArgumentValidity = function () {
            if (!a.isEmpty) {
              var t = 0;
              if (
                (null !== a.args && a.args.length > 0 && (t = a.args.length),
                ...
                if (0 !== t || (null !== e && e.hasParameters))
                  if (null === e && t > 0)
                    ...
                    null !== e &&
                    (null === e.args || (!e.args && t > 0))
                  )
                    a.Error(
                      "target (".concat(e.name, ") doesn't take parameters")
                    );
                  else if (a.parent instanceof Vt)
                    t > 0 &&
                      a.Error(
                        "can't store arguments in a divert target variable"
                      );
                  else {
                    var n,
                      r = e.args.length;
                    if (r !== t)
                      return (
                        (n =
                          0 === t
                            ? "but there weren't any passed to it"
                            : t < r
                            ? "but only got ".concat(t)
                            : "but got ".concat(t)),
                        void a.Error(
                          "to '"
                            .concat(e.identifier, "' requires ")
                            .concat(r, " arguments, ")
                            .concat(n)
                        )
                      );
                      ...
                      if (o.isDivertTarget) {
                        ...
                        if (s instanceof Vt || null !== l) {
                          if (l) {
                            ...
                            u.ResolveFromContext(l) &&
                              a.Error(
                                "Passing read count of '"
                                  .concat(
                                    u.dotSeparatedComponents,
                                    "' instead of a divert target. You probably meant '"
                                  )
                                  .concat(u, "'")
                              );
                          }
          ...
          (a.CheckExternalArgumentValidity = function (t) {
            var e = a.target ? a.target.firstComponent : null,
              n = t.externals.get(e);
            if (!n) throw new Error("external not found");
      ...
      return (
        i(r, [
          ...
          },
          {
            ...
            get: function () {
              return Boolean(
                this.target && "END" === this.target.dotSeparatedComponents
              );
            },
          },
          {
            ...
            get: function () {
              return Boolean(
                this.target && "DONE" === this.target.dotSeparatedComponents
              );
            },
          },
          {
          ...
          },
          {
            ...
            value: function (t) {
              if (!(this.isEmpty || this.isEnd || this.isDone)) {
                if (!this.runtimeDivert) throw new Error();
                this.targetContent &&
                  (this.runtimeDivert.targetPath =
                    this.targetContent.runtimePath),
                  p(o(r.prototype), "ResolveReferences", this).call(this, t);
                var e = _(this.targetContent, Ot);
                e &&
                  (!e.isFunction && this.isFunctionCall
                    ? p(o(r.prototype), "Error", this).call(
                        this,
                        ""
                          .concat(
                            e.identifier,
                ...
                if (1 === this.target.numberOfComponents) {
                  ...
                  if (
                    ((i = Rt.IsBuiltIn(this.target.firstComponent)),
                      ...
                      this.isFunctionCall ||
                        p(o(r.prototype), "Error", this).call(
                          ...
                          ""
                            ...
                            .concat(this.target.firstComponent, "()")
                        ),
                      void (
                        a &&
                        ((this.runtimeDivert.isExternal = !0),
                        null !== this.args &&
                          (this.runtimeDivert.externalArgs = this.args.length),
                        (this.runtimeDivert.pushesToStack = !1),
                        (this.runtimeDivert.targetPath = new R(
                          this.target.firstComponent
                        )),
                ...
                null == this.runtimeDivert.variableDivertName &&
                  (n ||
                    i ||
                    a ||
            ...
            value: function (t) {
              var e =
                ...
                n =
                  ...
                  arguments[2];
              e !== this && e
                ? p(o(r.prototype), "Error", this).call(this, t, e)
                : this.isFunctionCall
                ? p(o(r.prototype), "Error", this).call(
                    this,
                    "Function call ".concat(t),
                    e,
                    n
                  )
                : p(o(r.prototype), "Error", this).call(
    ...
    Bt = i(function t(e, r) {
      n(this, t), (this.divert = e), (this.targetRuntimeObj = r);
    }),
    Mt = i(function t(e, r) {
      n(this, t), (this.divert = e), (this.targetContent = r);
    });
  !(function (t) {
  ...
  var Gt,
        ...
        n(this, r),
          ...
          (a.GenerateRuntimeObject = function () {
            ...
            if (
              (e && (o += 1),
              r || e
                ? (t.AddContent(new J(o - 1)),
                  t.AddContent(it.CallWithName("MIN")))
                : n &&
                  (t.AddContent(new J(a.sequenceElements.length)),
              ...
              if (e || r) {
                var l = r
                  ? a.sequenceElements.length - 1
                  : a.sequenceElements.length;
            ...
            for (var h = et.NoOp(), f = 0; f < o; f += 1) {
              t.AddContent(et.EvalStart()),
                ...
                t.AddContent(et.EvalEnd());
              var d = new vt();
              (d.isConditional = !0), t.AddContent(d);
              var v = void 0;
        ...
        i(r, [
          ...
          },
          {
            ...
            value: function (t) {
              p(o(r.prototype), "ResolveReferences", this).call(this, t);
              var e,
                n = S(this._sequenceDivertsToResolve);
              try {
                for (n.s(); !(e = n.n()).done; ) {
                  var i = e.value;
    ...
    Ut = (function (t) {
      ...
      function r() {
        ...
        return (
          ...
          (t.GenerateRuntimeObject = function () {
            var e = new tt();
            if ((e.AddContent(et.EvalStart()), t.divertAfter)) {
              ...
              if (r) {
                ...
                if (null !== i && i.length > 0) {
                  for (
                    ...
                    var l = r.content[s];
                    l &&
                      (-1 == a && l.commandType === et.CommandType.EvalStart
                        ? (a = s)
                        : l.commandType === et.CommandType.EvalEnd && (o = s));
                  }
                  for (var u = a + 1; u < o; u += 1) {
                    (r.content[u].parent = null), e.AddContent(r.content[u]);
                  }
                }
              }
              var c = _(n, vt);
            ...
            } else e.AddContent(new rt());
            return e.AddContent(et.EvalEnd()), e.AddContent(et.PopTunnel()), e;
          }),
          (t.toString = function () {
        ...
        i(r, [
          ...
          },
          {
            ...
            value: function (t) {
              p(o(r.prototype), "ResolveReferences", this).call(this, t),
                this.divertAfter &&
                  this.divertAfter.targetContent &&
      ...
      return (
        i(t, [
          ...
          },
          {
            ...
            value: function (t, e) {
              var n,
                r = S(this._itemNameToValues);
              try {
                for (r.s(); !(n = r.n()).done; ) {
                  var i = m(n.value, 2),
                    a = i[0];
                  if (i[1] == t)
                    return { result: new B(this.name, a), exists: !0 };
                }
              } catch (t) {
                r.e(t);
              } finally {
        ...
        n(this, r),
          ...
          (i.GenerateRuntimeObject = function () {
            var t,
              ...
              n,
              r = new M(),
              a = S(i.itemDefinitions);
            try {
              for (a.s(); !(n = a.n()).done; ) {
                var o = n.value;
                if (o.inInitialList) {
                  var s = new B(
                    (null === (t = i.identifier) || void 0 === t
                      ? void 0
                      : t.name) || null,
                    o.name || null
                  );
            ...
            return (
              r.SetInitialOriginName(
                (null === (e = i.identifier) || void 0 === e
                  ? void 0
                  : e.name) || ""
              ),
              new Z(r)
                  ...
                  n.has(i.name)
                    ? this.Error(
                        "List '"
                          .concat(
                            this.identifier,
                            "' contains duplicate items called '"
                          )
                          .concat(i.name, "'")
                      )
                    : n.set(i.name, i.seriesValue);
                }
              } catch (t) {
                r.e(t);
              } finally {
    ...
    Jt = (function (t) {
      ...
      function r(t) {
        var i,
          a = t.assignedExpression,
          o = t.isGlobalDeclaration,
          s = t.isTemporaryNewDeclaration,
          l = t.listDef,
          u = t.variableIdentifier;
        return (
          n(this, r),
          ...
          (i.GenerateRuntimeObject = function () {
            ...
            if (
              (i.isGlobalDeclaration
                ? (t = i.story)
                : i.isNewTemporaryDeclaration && (t = Nt(h(i))),
            ...
            return (
              i.expression
                ? e.AddContent(i.expression.runtimeObject)
                : i.listDefinition &&
                  e.AddContent(i.listDefinition.runtimeObject),
              (i._runtimeAssignment = new pt(
                i.variableName,
                i.isNewTemporaryDeclaration
              )),
      ...
      return (
        i(r, [
          ...
          },
          {
            key: "typeName",
            get: function () {
              return this.isNewTemporaryDeclaration
                ? "temp"
                : this.isGlobalDeclaration
                ? null !== this.listDefinition
                  ? "LIST"
                  : "VAR"
                : "variable assignment";
            },
          ...
          },
          {
            ...
            value: function (t) {
              if (
                ...
                this.isDeclaration &&
                  ...
                  t.CheckForNamingCollisions(
                    ...
                    this.isGlobalDeclaration ? ft.Var : ft.Temp
                  ),
                this.isGlobalDeclaration)
              ) {
                var e = _(this.expression, Wt);
                !e ||
                  e.isConstantReference ||
                  e.isListItemReference ||
                  this.Error(
              ...
              if (!this.isNewTemporaryDeclaration) {
                ...
                n.found ||
                  (this.variableName in this.story.constants
                    ? this.Error(
                        "Can't re-assign to a constant (do you need to use VAR when declaring '".concat(
                          this.variableName,
                          "'?)"
                        ),
                        this
                    ...
                    : this.Error(
                        "Variable could not be found to assign to: '".concat(
                          this.variableName,
                          "'"
                        ),
                        this
        ...
        return (
          ...
          (i.ResolveWeavePointNaming = function () {
            var t,
              ...
              r = [].concat(
                g(
                  i.FindAll(Tt)(function (t) {
                    return !(null === t.name || void 0 === t.name);
                  })
                ),
                g(
                  i.FindAll(mt)(function (t) {
                    return !(null === t.name || void 0 === t.name);
                  })
                )
              );
            ...
            try {
              for (o.s(); !(a = o.n()).done; ) {
                var s = a.value,
                  l = i.namedWeavePoints.get(
                    (null === (t = s.identifier) || void 0 === t
                      ? void 0
                      : t.name) || ""
                  );
                if (l) {
                  ...
                  i.Error(
                    "A "
                      .concat(u, " with the same label name '")
                      .concat(
                        s.name,
                      ...
                      .concat(
                        c.debugMetadata
                          ? c.debugMetadata.startLineNumber
                          : "NO DEBUG METADATA AVAILABLE"
                      ),
                    s
                  );
                }
                (null === (e = s.identifier) || void 0 === e
                  ? void 0
                  : e.name) &&
                  i.namedWeavePoints.set(
                    null === (n = s.identifier) || void 0 === n
                      ? void 0
                      : n.name,
                    s
                  );
              ...
              if (e instanceof mt || e instanceof Tt) {
                ...
                if (n > i.baseIndentIndex) {
                  for (var a = t; t < i.content.length; ) {
                    ...
                    if (null !== o)
                      if (o.indentationDepth - 1 <= i.baseIndentIndex) break;
                    t += 1;
                  }
                  var s = t - a,
          ...
          (i.GenerateRuntimeObject = function () {
              ...
              for (e.s(); !(t = e.n()).done; ) {
                ...
                if (n instanceof mt || n instanceof Tt)
                  ...
                  i.AddRuntimeForNestedWeave(o),
                    (a = i.gatherPointsToResolve).splice.apply(
                      a,
                      [0, 0].concat(g(o.gatherPointsToResolve))
                    );
                } else i.AddGeneralRuntimeContent(n.runtimeObject);
              }
            } catch (t) {
              e.e(t);
            } finally {
            ...
            return i.PassLooseEndsToAncestors(), i._rootContainer;
          }),
          (i.AddRuntimeForGather = function (t) {
            ...
            if (
              (t.name ||
                ((n.name = "g-".concat(i._unnamedGatherCount)),
                (i._unnamedGatherCount += 1)),
              e)
            ) {
              if (!i.currentContainer) throw new Error();
              i.currentContainer.AddContent(n);
            } else i.rootContainer.AddToNamedContentOnly(n);
            var r,
              a = S(i.looseEnds);
            try {
              for (a.s(); !(r = a.n()).done; ) {
                var o = r.value;
                if (o instanceof Tt)
                  if (o.indentationDepth == t.indentationDepth) continue;
                var s = null;
                if (o instanceof jt) s = o.runtimeObject;
                else {
                  s = new vt();
                  var l = o;
                  if (!l.runtimeContainer) throw new Error();
            ...
            (i.looseEnds = []), (i.currentContainer = n);
          }),
          (i.AddRuntimeForWeavePoint = function (t) {
            if (t instanceof Tt) i.AddRuntimeForGather(t);
            else if (t instanceof mt) {
              if (!i.currentContainer) throw new Error();
              i.previousWeavePoint instanceof Tt &&
                i.looseEnds.splice(
                  i.looseEnds.indexOf(i.previousWeavePoint),
                  1
                );
              var e = t;
              if (
                (i.currentContainer.AddContent(e.runtimeObject),
                !e.innerContentContainer)
              )
                throw new Error();
              (e.innerContentContainer.name = "c-".concat(i._choiceCount)),
                i.currentContainer.AddToNamedContentOnly(
                  e.innerContentContainer
                ),
                (i._choiceCount += 1),
            ...
            if (null !== t)
              if (i.addContentToPreviousWeavePoint) {
                if (
                  ...
                  !i.previousWeavePoint.runtimeContainer
                )
                  throw new Error();
          ...
          (i.PassLooseEndsToAncestors = function () {
            if (0 !== i.looseEnds.length) {
              for (
                var t = null, e = null, n = !1, a = i.parent;
                null !== a;
                a = a.parent
              ) {
                var o = _(a, r);
                o && (n || null !== t || (t = o), n && null === e && (e = o)),
                ...
                for (var s = i.looseEnds.length - 1; s >= 0; s -= 1) {
                  ...
                  if (n) {
                    if (l instanceof mt && null !== t)
                      t.ReceiveLooseEnd(l), (u = !0);
                    else if (!(l instanceof mt)) {
                      var c = t || e;
                      null !== c && (c.ReceiveLooseEnd(l), (u = !0));
                    }
                  } else
                    (null == t
                      ? void 0
                      : t.hasOwnProperty("ReceiveLooseEnd")) &&
                      t.ReceiveLooseEnd(l),
                      (u = !0);
          ...
          (i.WeavePointNamed = function (t) {
            if (!i.namedWeavePoints) return null;
          ...
          (i.IsGlobalDeclaration = function (t) {
            var e = _(t, Jt);
            return (
              !!(e && e.isGlobalDeclaration && e.isDeclaration) || !!_(t, _t)
            );
          }),
          (i.ContentThatFollowsWeavePoint = function (t) {
            ...
            for (
              var u = l.content.indexOf(n) + 1;
              u < l.content.length;
              u += 1
            ) {
              var c = l.content[u];
              if (!i.IsGlobalDeclaration(c)) {
                if (c instanceof mt || c instanceof Tt) break;
                if (c instanceof r) break;
                e.push(c);
              }
            }
            return e;
            ...
            if (!(i.lastParsedSignificantObject instanceof W))
              if (null !== i.looseEnds && i.looseEnds.length > 0) {
                ...
                try {
                  for (s.s(); !(o = s.n()).done; ) {
                    var l = o.value;
                    if (l instanceof mt || l instanceof jt) return;
                  }
                } catch (t) {
                  s.e(t);
                } finally {
          ...
          (i.BadNestedTerminationHandler = function (t) {
            ...
            null !== e &&
              1 === e.FindAll(mt)().length &&
              (r =
                "Choices with conditions should be written: '* {condition} choice'. Otherwise, ".concat(
                  r.toLowerCase()
                ));
            i.Error(r, t);
          }),
          (i.ValidateFlowOfObjectsTerminates = function (t, e, n) {
            ...
            try {
              for (o.s(); !(r = o.n()).done; ) {
                ...
                if (
                  (null !==
                    s.Find(jt)(function (t) {
                      return !(
                        t.isThread ||
                        t.isTunnel ||
                        t.isFunctionCall ||
                        t.parent instanceof Vt
                      );
                    }) && (i = !0),
                  null != s.Find(Ut)())
                ) {
            ...
            if (!i) {
              if (a instanceof W) return;
              n(a);
            }
          }),
          (i.WeavePointHasLooseEnd = function (t) {
            if (null === t.content) return !0;
            for (var e = t.content.length - 1; e >= 0; --e) {
              var n = _(t.content[e], jt);
              if (n)
                if (!(n.isThread || n.isTunnel || n.isFunctionCall)) return !1;
            }
            return !0;
          }),
                  ...
                  try {
                    for (h.s(); !(s = h.n()).done; ) {
                      ...
                      if (f && f !== c) {
                        var d = ""
                          .concat(c.GetType(), " '")
                          .concat(u, "' has the same label name as a ")
                          .concat(f.GetType(), " (on ")
                          .concat(f.debugMetadata, ")");
                        i.Error(d, c);
                      }
                    }
                  } catch (t) {
          ...
          (i.baseIndentIndex =
            -1 == a ? i.DetermineBaseIndentationFromContent(t) : a),
          i.AddContent(t),
      ...
      return (
        i(r, [
          ...
          },
          {
            ...
            get: function () {
              if (0 === this.content.length) return null;
              ...
              var i = _(t, r);
              return i && (t = i.lastParsedSignificantObject), t;
            },
          },
          {
            key: "typeName",
          ...
          },
          {
            ...
            value: function (t) {
              ...
              var i,
                a = S(this.gatherPointsToResolve);
              try {
                for (a.s(); !(i = a.n()).done; ) {
                  var s = i.value;
      ...
      function r(t) {
        ...
        return (
          ...
          (i.GenerateRuntimeObject = function () {
            if (i._innerWeave) {
              var t,
                e = S(i._innerWeave.content);
              try {
                for (e.s(); !(t = e.n()).done; ) {
                  var n = _(t.value, Et);
                  n &&
                    n.text.startsWith("else:") &&
                    i.Warning(
            ...
            return (
              r.AddContent(i._conditionalDivert),
              ...
              (a || (i.isElse && i.matchingEquality)) &&
                i._contentContainer.InsertContent(et.PopEvaluatedValue(), 0),
          ...
          (i.GenerateRuntimeForContent = function () {
            return null === i._innerWeave
              ? new tt()
              : i._innerWeave.rootContainer;
          }),
          t && ((i._innerWeave = new zt(t)), i.AddContent(i._innerWeave)),
          i
        );
      }
      return (
          ...
          },
          {
            ...
            value: function (t) {
              if (!this._conditionalDivert || !this._contentContainer)
                throw new Error();
              (this._conditionalDivert.targetPath =
                this._contentContainer.path),
                p(o(r.prototype), "ResolveReferences", this).call(this, t);
            },
          },
        ]),
  ...
  var Xt,
            ...
            value: function (e) {
              ...
              return (
                ...
                this.startLineNumber < e.startLineNumber
                  ? ((n.startLineNumber = this.startLineNumber),
                    (n.startCharacterNumber = this.startCharacterNumber))
                  : this.startLineNumber > e.startLineNumber
                  ? ((n.startLineNumber = e.startLineNumber),
                    (n.startCharacterNumber = e.startCharacterNumber))
                  : ((n.startLineNumber = this.startLineNumber),
                    (n.startCharacterNumber = Math.min(
                      this.startCharacterNumber,
                      e.startCharacterNumber
                    ))),
                this.endLineNumber > e.endLineNumber
                  ? ((n.endLineNumber = this.endLineNumber),
                    (n.endCharacterNumber = this.endCharacterNumber))
                  : this.endLineNumber < e.endLineNumber
                  ? ((n.endLineNumber = e.endLineNumber),
                    (n.endCharacterNumber = e.endCharacterNumber))
                  : ((n.endLineNumber = this.endLineNumber),
                    (n.endCharacterNumber = Math.max(
                      this.endCharacterNumber,
                      e.endCharacterNumber
                    ))),
                n
              );
            },
          },
          {
            ...
            value: function () {
              return null !== this.fileName
                ? "line "
                    .concat(this.startLineNumber, " of ")
                    .concat(this.fileName, '"')
                : "line " + this.startLineNumber;
            },
          },
        ]),
        t
    ...
    Zt = (function (t) {
      ...
      function r(t, i) {
        ...
        return (
          ...
          (a.argumentNames = i),
          (a.GenerateRuntimeObject = function () {
            return a.story.AddExternal(h(a)), null;
          }),
          a
        );
      }
      return (
        i(r, [
          ...
          },
          {
            ...
            value: function () {
              var t;
              return "EXTERNAL ".concat(
                null === (t = this.identifier) || void 0 === t ? void 0 : t.name
              );
            },
          },
        ]),
    ...
    Qt = i(function t(e, r, i) {
      n(this, t), (this.name = e), (this.args = r), (this.isFunction = i);
    }),
    te = (function (t) {
      a(r, t);
      var e = d(r);
      ...
      function r(t, i, a) {
        ...
        return (
          ...
          (o.GenerateIntoContainer = function (t) {
            ...
            t.AddContent(
              new Ft(
                (null === (e = o.varIdentifier) || void 0 === e
                  ? void 0
                  : e.name) || null
              )
            ),
              o.expression
                ? o.expression.GenerateIntoContainer(t)
                : t.AddContent(new J(1)),
              t.AddContent(it.CallWithName(o.isInc ? "+" : "-")),
              (o._runtimeAssignment = new pt(
                (null === (n = o.varIdentifier) || void 0 === n
                  ? void 0
                  : n.name) || null,
                !1
              )),
          ...
          (o.toString = function () {
            ...
            return o.expression
              ? ""
                  .concat(
                    null === (t = o.varIdentifier) || void 0 === t
                      ? void 0
                      : t.name
                  )
                  .concat(o.isInc ? " += " : " -= ")
        ...
        i(r, [
          ...
          },
          {
            ...
            value: function (t) {
              var e;
              p(o(r.prototype), "ResolveReferences", this).call(this, t);
              var n = t.ResolveVariableWithName(
                (null === (e = this.varIdentifier) || void 0 === e
                  ? void 0
                  : e.name) || "",
                this
              );
              if (
                (n.found ||
                  this.Error(
                    "variable for "
                      .concat(
                        this.incrementDecrementWord,
                        " could not be found: '"
                      )
                      .concat(
                        this.varIdentifier,
                        "' after searching: {this.descriptionOfScope}"
                      )
                  ),
                !this._runtimeAssignment)
              )
    ...
    ae = (function (t) {
      ...
      var e = d(r);
      function r(t, i, a, o) {
        return n(this, r), e.call(this, t, i, a, o);
      }
      return (
        i(r, [
          {
              ...
              for (var n in this.subFlowsByName) {
                ...
                if (i) {
                  var a = this.subFlowsByName.get(n),
                    s = "Stitch '"
                      .concat(
                        a ? a.name : "NO STITCH FOUND",
                        "' has the same name as a knot (on "
                      )
                      .concat(i.debugMetadata, ")");
                  this.Error(s, a);
                }
              }
            },
              ...
              try {
                for (o.s(); !(a = o.n()).done; ) {
                  var s = a.value,
                    ...
                    u = null,
                    c = "";
                  l.length > 1 ? ((u = l[0]), (c = l[1])) : (c = l[0]);
                  var f = i.story.ResolveListItem(u, c, h(i));
                  if (null === f)
                    null === u
                      ? i.Error(
                          "Could not find list definition that contains item '".concat(
                            s,
                            "'"
                          )
                        )
                      : i.Error("Could not find list item ".concat(s));
                  else {
                    if (null == f.parent)
                      return void i.Error(
                        "Could not find list definition for item ".concat(s)
                      );
                    u ||
                      (u =
                        (null === (n = f.parent.identifier) || void 0 === n
                          ? void 0
                          : n.name) || null);
                    var d = new B(u, f.name || null);
                    r.has(d.serialized())
                      ? i.Warning("Duplicate of item '".concat(s, "' in list."))
                      : r.Add(d, f.seriesValue);
                  }
                }
              } catch (t) {
                o.e(t);
    ...
    se = (function (t) {
      ...
      function r(t, i) {
        ...
        return (
          ...
          (s.parent = p(((a = h(s)), o(r.prototype)), "parent", a)),
          s
        );
      }
      return (
        i(r, [
          {
            ...
            get: function () {
              ...
              return ""
                .concat(
                  null === (t = e.identifier) || void 0 === t ? void 0 : t.name,
                  "."
                )
                .concat(this.name);
            },
          ...
          },
          {
            ...
            get: function () {
              var t;
              return (
                (null === (t = this.indentifier) || void 0 === t
                  ? void 0
                  : t.name) || null
              );
            },
  ...
  var le = (function (t) {
      ...
      function r(t, i, a, s) {
        ...
        return (
          ...
          ((u = e.call(this, t, i, a, s)).toString = function () {
            return ""
              .concat(null !== u.parent ? u.parent + " > " : "")
              .concat(p(((l = h(u)), o(r.prototype)), "toString", l).call(l));
          }),
          u
        );
      }
    ...
    ue = (function (t) {
      ...
      function r(t) {
        var i;
        return n(this, r), ((i = e.call(this)).text = t.toString() || ""), i;
      }
      return (
        i(r, [
          {
      ...
      return (
        i(t, null, [
          ...
          },
          {
            ...
            value: function (e, n) {
              var r = _(n, tt);
              if (r) this.WriteRuntimeContainer(e, r);
              else {
                var i = _(n, vt);
                if (i) {
                  var a,
                  ...
                  return (
                    i.isExternal
                      ? (o = "x()")
                      : i.pushesToStack &&
                        (i.stackPushType == ct.Function
                          ? (o = "f()")
                          : i.stackPushType == ct.Tunnel && (o = "->t->")),
                    (a = i.hasVariableTarget
                    ...
                    i.externalArgs > 0 &&
                      e.WriteIntProperty("exArgs", i.externalArgs),
                ...
                var l = _(n, H);
                if (l) e.WriteBool(l.value);
                else {
                  var u = _(n, J);
                  if (u) e.WriteInt(u.value);
                  else {
                    var c = _(n, z);
                    if (c) e.WriteFloat(c.value);
                    else {
                      var h = _(n, $);
                      if (h)
                        h.isNewline
                        ...
                        if (f) this.WriteInkList(e, f);
                          ...
                          if (d)
                            return (
                              e.WriteObjectStart(),
                              null === d.value
                                ? L("divTargetVal.value")
                                : (e.WriteProperty(
                                    "^->",
                                    d.value.componentsString
                                  ),
                                  void e.WriteObjectEnd())
                            );
                          var v = _(n, Y);
                          ...
                          if (_(n, ee)) e.Write("<>");
                            ...
                            if (p)
                              ...
                              if (y) {
                                ...
                                return (
                                  null != C
                                    ? e.WriteProperty("CNT?", C)
                                    : e.WriteProperty("VAR?", y.name),
                                  void e.WriteObjectEnd()
                                );
                              }
                              var S = _(n, pt);
                              if (S) {
                                ...
                                return (
                                  e.WriteProperty(b, S.variableName),
                                  S.isNewDeclaration ||
                                    e.WriteProperty("re", !0),
                                  void e.WriteObjectEnd()
                                );
                              }
                              if (_(n, rt)) e.Write("void");
                              else {
                                var w = _(n, ue);
                                if (w)
                                  return (
          ...
          },
          {
            ...
            value: function (n) {
              ...
              if ("string" == typeof n) {
                var r = n.toString(),
                  i = r[0];
                if ("^" == i) return new $(r.substring(1));
                if ("\n" == i && 1 == r.length) return new $("\n");
                if ("<>" == r) return new ee();
                for (var a = 0; a < t._controlCommandNames.length; ++a) {
                  if (r == t._controlCommandNames[a]) return new et(a);
                }
                if (("L^" == r && (r = "^"), it.CallExistsWithName(r)))
                  return it.CallWithName(r);
                if ("->->" == r) return et.PopTunnel();
                if ("~ret" == r) return et.PopFunction();
                if ("void" == r) return new rt();
              }
              if ("object" === e(n) && !Array.isArray(n)) {
                var o,
                  s = n;
                if (s["^->"]) return (o = s["^->"]), new X(new R(o.toString()));
                if (s["^var"]) {
                  o = s["^var"];
                  var l = new Y(o.toString());
                  return (
                    "ci" in s && ((o = s.ci), (l.contextIndex = parseInt(o))), l
                  );
                }
                var u = !1,
                  c = !1,
                ...
                if (
                  ((o = s["->"])
                    ? (u = !0)
                    : (o = s["f()"])
                    ? ((u = !0), (c = !0), (h = ct.Function))
                    : (o = s["->t->"])
                    ? ((u = !0), (c = !0), (h = ct.Tunnel))
                    : (o = s["x()"]) &&
                      ((u = !0), (f = !0), (c = !1), (h = ct.Function)),
                  u)
                ) {
                  var d = new vt();
                  (d.pushesToStack = c),
                  ...
                  return (
                    (o = s.var)
                      ? (d.variableDivertName = v)
                      : (d.targetPathString = v),
                    (d.isConditional = !!s.c),
                ...
                if ((o = s["*"])) {
                  var p = new ht();
                  return (
                    (p.pathStringOnChoice = o.toString()),
                    (o = s.flg) && (p.flags = parseInt(o)),
                    p
                  );
                }
                if ((o = s["VAR?"])) return new Ft(o.toString());
                if ((o = s["CNT?"])) {
                  var m = new Ft();
                  return (m.pathStringForCount = o.toString()), m;
                }
                var g = !1,
                  y = !1;
                if (
                  ...
                  var C = o.toString(),
                    S = !s.re,
                    b = new pt(C, S);
                  return (b.isGlobal = y), b;
                }
                if (void 0 !== s["#"])
                  return (o = s["#"]), new ue(o.toString());
                if ((o = s.list)) {
                  var w = o,
                    k = new M();
                  if ((o = s.origins)) {
          ...
          },
          {
            ...
            value: function (t, e) {
              var n =
                arguments.length > 2 && void 0 !== arguments[2] && arguments[2];
              if ((t.WriteArrayStart(), null === e)) return L("container");
              var r,
                i = S(e.content);
              try {
                for (i.s(); !(r = i.n()).done; ) {
              ...
              var o = e.namedOnlyContent,
                ...
                l = null != e.name && !n,
                u = null != o || s > 0 || l;
              if ((u && t.WriteObjectStart(), null != o)) {
                var c,
                  h = S(o);
                try {
                  for (h.s(); !(c = h.n()).done; ) {
              ...
              try {
                for (i.s(); !(r = i.n()).done; ) {
                  var a = m(r.value, 2),
                    ...
                    u = s;
                  if (null === l.itemName) return L("item.itemName");
                  ...
                  try {
                    for (s.s(); !(i = s.n()).done; ) {
                      var l = m(i.value, 2),
                        ...
                        c = l[1],
                        h = B.fromSerializedKey(u);
                      if (null === h.itemName) return L("item.itemName");
                      o[h.itemName] = c;
                    }
                  } catch (t) {
                    s.e(t);
  ...
  var de = (function () {
    function e() {
      if (
        ...
        var r = arguments[0];
        (this._startOfRoot = dt.StartOf(r.rootContentContainer)), this.Reset();
      } else {
        var i = arguments[0];
        this._threads = [];
        var a,
          ...
          value: function () {
            (this._threads = []),
              ...
              this._threads[0].callstack.push(
                new e.Element(ct.Tunnel, this._startOfRoot)
              );
          },
        },
        {
          ...
          get: function () {
            for (var t = new j(), e = 0; e < this._threads.length; e++) {
              ...
              for (var i = 0; i < n.callstack.length; i++) {
                n.callstack[i].type == ct.Function
                  ? t.Append("  [FUNCTION] ")
                  : t.Append("  [TUNNEL] ");
          ...
          try {
            for (s.s(); !(a = s.n()).done; ) {
              ...
              if (void 0 !== d) {
                ...
                if (v.approximate) {
                  if (null === h.container) return L("pointer.container");
                  i.Warning(
              ...
              var p = !!u.exp,
                ...
                g = u.temp;
              void 0 !== g
                ? (m.temporaryVariables = fe.JObjectToDictionaryRuntimeObjs(g))
                : m.temporaryVariables.clear(),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (
                ...
                if (null === i) return L("this.previousPointer.Resolve()");
      ...
      i(r, [
        {
          ...
          value: function (t, e) {
            var n,
              r = S(this.variableChangedEventCallbacks);
            try {
              for (r.s(); !(n = r.n()).done; ) {
                (0, n.value)(t, e);
              }
        ...
        },
        {
          ...
          set: function (t) {
            if (((this._batchObservingVariableChanges = t), t))
              ...
              var e,
                n = S(this._changedVariablesForBatchObs);
              try {
                for (n.s(); !(e = n.n()).done; ) {
                  var r = e.value,
        ...
        },
        {
          key: "ApplyPatch",
          value: function () {
            if (null === this.patch) return L("this.patch");
            var t,
              e = S(this.patch.globals);
            try {
              for (e.s(); !(t = e.n()).done; ) {
                var n = m(t.value, 2),
                  r = n[0],
            ...
            if (null !== this._changedVariablesForBatchObs) {
              var a,
                o = S(this.patch.changedVariables);
              try {
                for (o.s(); !(a = o.n()).done; ) {
                  var s = a.value;
        ...
        },
        {
          ...
          value: function (t) {
            ...
            var e,
              n = S(this._defaultGlobalVariables);
            try {
              for (n.s(); !(e = n.n()).done; ) {
                var r = m(e.value, 2),
                  i = r[0],
                ...
                if (void 0 !== o) {
                  ...
                  if (null === s) return L("tokenInkObject");
                  this._globalVariables.set(i, s);
                } else this._globalVariables.set(i, a);
              }
            } catch (t) {
              n.e(t);
            } finally {
            ...
            try {
              for (n.s(); !(e = n.n()).done; ) {
                var i = m(e.value, 2),
                  ...
                  l = o;
                if (
                  r.dontSaveDefaultValues &&
                  this._defaultGlobalVariables.has(s)
                ) {
                  var u = this._defaultGlobalVariables.get(s);
                  if (this.RuntimeObjectsEqual(l, u)) continue;
                }
        ...
        },
        {
          ...
          value: function (t, e) {
            if (null === t) return L("obj1");
            if (null === e) return L("obj2");
            if (t.constructor !== e.constructor) return !1;
            var n = _(t, H);
            if (null !== n) return n.value === T(e, H).value;
            var r = _(t, J);
            if (null !== r) return r.value === T(e, J).value;
            var i = _(t, z);
            if (null !== i) return i.value === T(e, z).value;
            var a = _(t, K),
              o = _(e, K);
            if (null !== a && null !== o)
              return N(a.valueObject) && N(o.valueObject)
        ...
        },
        {
          ...
          value: function (t, e) {
            if (0 == e || -1 == e) {
              ...
              if (
                null !== this._defaultGlobalVariables &&
                (n = q(this._defaultGlobalVariables, t, null)).exists
              )
                return n.result;
        ...
        },
        {
          ...
          value: function (t, e) {
            ...
            if (null === n) return L("name");
            var r = -1,
              i = !1;
            if (
              ((i = t.isNewDeclaration
                ? t.isGlobal
              ...
              var o = null;
              do {
                null != (o = _(this.GetRawVariableWithName(n, r), Y)) &&
                  ((n = o.variableName), (i = 0 == (r = o.contextIndex)));
              } while (null != o);
            }
            i
              ? this.SetGlobal(n, e)
        ...
        },
        {
          ...
          value: function (t, e) {
            var n = null;
            if (
              (null === this.patch && (n = q(this._globalVariables, t, null)),
              null !== this.patch &&
                ((n = this.patch.TryGetGlobal(t, null)).exists ||
                  (n = q(this._globalVariables, t, null))),
  ...
  var ye,
    Ce = (function () {
      function t() {
        ...
        var e = arguments[0],
          r = arguments[1];
        if (((this.name = e), (this.callStack = new de(r)), arguments[2])) {
          var i = arguments[2];
        ...
        i(t, [
          {
            ...
            value: function (t) {
              ...
              r && (t.WriteObjectEnd(), t.WritePropertyEnd()),
                t.WriteProperty("currentChoices", function (t) {
                  t.WriteArrayStart();
                  var n,
                    r = S(e.currentChoices);
                  try {
                    for (r.s(); !(n = r.n()).done; ) {
                      var i = n.value;
                      fe.WriteChoice(t, i);
          ...
          },
          {
            ...
            value: function (t, e) {
              var n,
                r = S(this.currentChoices);
              try {
                for (r.s(); !(n = r.n()).done; ) {
                  var i = n.value,
                    a = this.callStack.ThreadWithIndex(i.originalThreadIndex);
                  if (null !== a) i.threadAtGeneration = a.Copy();
                  else {
      ...
      return (
        i(e, [
          ...
          },
          {
            ...
            value: function (t) {
              ...
              var n = t.path.toString(),
                r = q(this._visitCounts, n, null);
              r.exists
                ? this._visitCounts.set(n, r.result + 1)
                ...
                try {
                  for (r.s(); !(t = r.n()).done; ) {
                    ...
                    if (n || null === a) {
                      var o = _(i, et);
                      null !== o &&
                        (o.commandType == et.CommandType.BeginTag
                          ? (n = !0)
                          : o.commandType == et.CommandType.EndTag && (n = !1));
            ...
            get: function () {
              if (this._outputStreamTagsDirty) {
                ...
                if (n.Length > 0) {
                  ...
                  this._currentTags.push(c), n.Clear();
                }
          ...
          },
          {
            key: "GoToStart",
            value: function () {
              this.callStack.currentElement.currentPointer = dt.StartOf(
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (
                ...
                var e,
                  n = q(this._namedFlows, t, null);
                n.exists
                  ? (e = n.result)
                  : ((e = new Ce(t, this.story)),
          ...
          },
          {
            ...
            value: function () {
              var t,
                ...
                o = new e(this.story);
              if (
                ((o._patch = new me(this._patch)),
                (o._currentFlow.name = this._currentFlow.name),
                (o._currentFlow.callStack = new de(
                  this._currentFlow.callStack
                )),
                (t = o._currentFlow.currentChoices).push.apply(
                  t,
                  g(this._currentFlow.currentChoices)
                ),
                (n = o._currentFlow.outputStream).push.apply(
                  n,
                  g(this._currentFlow.outputStream)
                ),
                o.OutputStreamDirty(),
                null !== this._namedFlows)
              ) {
                ...
                var s,
                  l = S(this._namedFlows);
                try {
                  for (l.s(); !(s = l.n()).done; ) {
                    var u = m(s.value, 2),
                      c = u[0],
                      h = u[1];
                    o._namedFlows.set(c, h), (o._aliveFlowNamesDirty = !0);
                  }
                } catch (t) {
                  l.e(t);
                } finally {
              ...
              this.hasError &&
                ((o._currentErrors = []),
                (i = o._currentErrors).push.apply(
                  i,
                  g(this.currentErrors || [])
                ));
              this.hasWarning &&
                ((o._currentWarnings = []),
                (a = o._currentWarnings).push.apply(
                  a,
                  g(this.currentWarnings || [])
                ));
              return (
                (o.variablesState = this.variablesState),
                ...
                this.divertedPointer.isNull ||
                  (o.divertedPointer = this.divertedPointer.copy()),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (null != r) {
                ...
                for (var a = 0, o = Object.entries(i); a < o.length; a++) {
                  ...
                  if (1 === Object.keys(i).length)
                    ...
                    if (null === this._namedFlows) return L("this._namedFlows");
                ...
                (this._namedFlows = null),
                  ...
                  (this._currentFlow.outputStream = fe.JArrayToRuntimeObjList(
                    e.outputStream
                  )),
                  (this._currentFlow.currentChoices = fe.JArrayToRuntimeObjList(
                    e.currentChoices
                  ));
              ...
              this.OutputStreamDirty(),
                ...
                (this.variablesState.callStack = this._currentFlow.callStack),
                (this._evaluationStack = fe.JArrayToRuntimeObjList(
                  e.evalStack
                ));
          ...
          },
          {
            ...
            value: function (t) {
              var e = t.value;
              if (null === e) return L("single.value");
              ...
              if ((-1 != o && (f = s), f > h)) {
                var v = e.substring(h, f);
                c.push(new $(v));
              }
              if (-1 != o && s > r && (c.push(new $("\n")), o < e.length - 1)) {
                var p = e.length - o - 1,
                  m = new $(e.substring(o + 1, o + 1 + p));
                c.push(m);
              }
              return c;
            },
          },
          {
            ...
            value: function (t) {
              ...
              if (e) this.TrimNewlinesFromOutputStream(), (r = !0);
                ...
                for (
                  var o = -1, s = this.outputStream.length - 1;
                  s >= 0;
                  s--
                ) {
                  ...
                  if (
                    null != u &&
                    u.commandType == et.CommandType.BeginString
                  ) {
                    s >= i && (i = -1);
                    break;
                  }
                ...
                if (
                  -1 != (-1 != o && -1 != i ? Math.min(i, o) : -1 != o ? o : i)
                ) {
                  if (n.isNewline) r = !1;
                  else if (
                    n.isNonWhitespace &&
                    (o > -1 && this.RemoveExistingGlue(), i > -1)
                  )
                    for (
                      var c = this.callStack.elements, h = c.length - 1;
                      h >= 0;
                      h--
                    ) {
                      var f = c[h];
                      if (f.type != ct.Function) break;
          ...
          },
          {
            ...
            value: function () {
              for (var t = this.outputStream.length - 1; t >= 0; t--) {
                ...
                if (e instanceof ee) this.outputStream.splice(t, 1);
                else if (e instanceof et) break;
              }
              this.OutputStreamDirty();
            },
          },
          {
            ...
            get: function () {
              if (this.outputStream.length > 0)
                for (var t = this.outputStream.length - 1; t >= 0; t--) {
                  if (this.outputStream[t] instanceof et) break;
                  var e = this.outputStream[t];
                  if (e instanceof $) {
          ...
          },
          {
            ...
            get: function () {
              var t,
                e = S(this.outputStream);
              try {
                for (e.s(); !(t = e.n()).done; ) {
                  if (t.value instanceof $) return !0;
                }
              } catch (t) {
                e.e(t);
              } finally {
          ...
          },
          {
            ...
            get: function () {
              for (var t = this.outputStream.length - 1; t >= 0; t--) {
                ...
                if (
                  e instanceof et &&
                  e.commandType == et.CommandType.BeginString
                )
                  return !0;
              }
              return !1;
                ...
                if (null != n.originNames) {
                  ...
                  try {
                    for (i.s(); !(r = i.n()).done; ) {
                      ...
                      var o = this.story.listDefinitions.TryListGetDefinition(
                        a,
                        null
                      );
                      if (null === o.result) return L("StoryState def.result");
                      n.origins.indexOf(o.result) < 0 &&
                        n.origins.push(o.result);
                    }
                  } catch (t) {
                    i.e(t);
                  } finally {
          ...
          },
          {
            ...
            value: function (t) {
              if (void 0 === t) return P(this.evaluationStack.pop());
          ...
          },
          {
            ...
            value: function () {
              ...
              for (var e = this.outputStream.length - 1; e >= t; e--) {
                ...
                if (null != r) {
                  if (i) break;
                  if (!r.isNewline && !r.isInlineWhitespace) break;
            ...
            value: function () {
              var t =
                arguments.length > 0 && void 0 !== arguments[0]
                  ? arguments[0]
                  : null;
              this.callStack.currentElement.type == ct.Function &&
              ...
              if (null !== t)
                for (var e = 0; e < t.length; e++) {
                  if (
                    ...
                    throw new Error((P(arguments[e]), "null"));
            ...
            value: function () {
              return (
                this.callStack.currentElement.type ==
                  ct.FunctionEvaluationFromGame &&
                ((this.currentPointer = dt.Null), (this.didSafeExit = !0), !0)
              );
            },
          },
          {
            ...
            value: function () {
              ...
              if ((this.PopCallStack(ct.FunctionEvaluationFromGame), e)) {
                if (e instanceof rt) return null;
                var r = T(e, K);
                return r.valueType == U.DivertTarget
                  ? r.valueObject.toString()
                  : r.valueObject;
              }
              return null;
            },
  ...
  !(function (t) {
    ...
    (t.Story = (function (t) {
      ...
      function o() {
        ...
        if (
          (null != i && (t._listDefinitions = new he(i)),
          ...
          (h = l.listDefs) &&
            (t._listDefinitions = fe.JTokenToListDefinitions(h)),
        ...
        i(o, [
          {
            ...
            get: function () {
              var t = [];
              if (null === this._state) return L("this._state");
              var e,
                n = S(this._state.currentChoices);
              try {
                for (n.s(); !(e = n.n()).done; ) {
                  var r = e.value;
                  r.isInvisibleDefault || ((r.index = t.length), t.push(r));
                }
              } catch (t) {
                n.e(t);
              } finally {
          ...
          { key: "EndProfiling", value: function () {} },
          {
            ...
            value: function (t) {
              ...
              if (
                ...
                var r,
                  i = S(this._listDefinitions.lists);
                try {
                  for (i.s(); !(r = i.n()).done; ) {
                    var a = r.value;
              ...
              if (
                ...
                (!r && this.canContinue) ||
                  ...
                  this.canContinue ||
                    ...
                    0 != this.state.generatedChoices.length ||
                      ...
                      (this.state.callStack.CanPop(ct.Tunnel)
                        ? this.AddError(
                            "unexpectedly reached end of content. Do you need a '->->' to return from a tunnel?"
                          )
                        : this.state.callStack.CanPop(ct.Function)
                        ? this.AddError(
                ...
                if (null === this.onError) {
                  ...
                  throw (
                    (i.Append("Ink had "),
                    this.state.hasError &&
                      (i.Append("".concat(this.state.currentErrors.length)),
                      i.Append(
                    ...
                    this.state.hasWarning &&
                      (i.Append("".concat(this.state.currentWarnings.length)),
                      i.Append(
                ...
                if (this.state.hasWarning) {
                  var l,
                    u = S(this.state.currentWarnings);
                  try {
                    for (u.s(); !(l = u.n()).done; ) {
                      var c = l.value;
            ...
            value: function () {
              if (
                ...
                if (null !== this._stateSnapshotAtLastNewline) {
                  ...
                  if (
                    t == o.OutputStateChange.ExtendedBeyondNewline ||
                    this._sawLookaheadUnsafeFunctionAfterNewline
                  )
                    return this.RestoreStateSnapshot(), !0;
                  t == o.OutputStateChange.NewlineRemoved &&
          ...
          },
          {
            ...
            value: function (t, e, n, r) {
              if (null === t) return L("prevText");
              if (null === e) return L("currText");
              var i =
                e.length >= t.length &&
                t.length > 0 &&
                "\n" == e.charAt(t.length - 1);
              ...
              if (!i) return o.OutputStateChange.NewlineRemoved;
              if (r > n) return o.OutputStateChange.ExtendedBeyondNewline;
          ...
          },
          {
            key: "PointerAtPath",
            value: function (t) {
              if (0 == t.length) return dt.Null;
              var e = new dt(),
                n = t.length,
                r = null;
              return null === t.lastComponent
                ? L("path.lastComponent")
                : (t.lastComponent.isIndex
                    ? ((n = t.length - 1),
                      (r = this.mainContentContainer.ContentAtPath(
                        t,
                        void 0,
                        n
                      )),
                    ...
                    : ((r = this.mainContentContainer.ContentAtPath(t)),
                      (e.container = r.container),
                      (e.index = -1)),
                  null == r.obj || (r.obj == this.mainContentContainer && n > 0)
                    ? this.Error(
            ...
            value: function () {
              ...
              if (!e.isNull) {
                ...
                if (!this.state.currentPointer.isNull) {
                  ...
                  if ((r instanceof tt && (t = !1), t)) {
                    var s = _(r, Y);
                    if (s && -1 == s.contextIndex) {
                      var l = this.state.callStack.ContextForVariableNamed(
                        s.variableName
                      );
                      r = new Y(s.variableName, l);
                    }
                    this.state.inExpressionEvaluation
                      ? this.state.PushEvaluationStack(r)
                      : this.state.PushToOutputStream(r);
                  }
                  this.NextContent();
                  var u = _(r, et);
                  u &&
                    u.commandType == et.CommandType.StartThread &&
              ...
              if (!e.isNull && -1 != e.index) {
                if (((this._prevContainers.length = 0), !t.isNull))
                  for (var n = _(t.Resolve(), tt) || _(t.container, tt); n; )
                    this._prevContainers.push(n), (n = _(n.parent, tt));
                var r = e.Resolve();
                if (null != r)
                  for (
                    var i = _(r.parent, tt), a = !0;
                    i &&
                    (this._prevContainers.indexOf(i) < 0 ||
                      i.countingAtStartOnly);
          ...
          },
          {
            ...
            value: function (t) {
              for (
                var e = T(this.state.PopEvaluationStack(), $);
                this.state.evaluationStack.length > 0 &&
                null != _(this.state.PeekEvaluationStack(), ue);
          ...
          },
          {
            ...
            value: function (t) {
              ...
              (t.hasChoiceOnlyContent &&
                (i = this.PopChoiceStringAndTags(a) || ""),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (t instanceof et) {
                ...
                switch (l.commandType) {
                  ...
                  case et.CommandType.PopTunnel:
                    var h =
                        l.commandType == et.CommandType.PopFunction
                          ? ct.Function
                          : ct.Tunnel,
                      f = null;
                    if (h == ct.Tunnel) {
                    ...
                    if (
                      this.state.callStack.currentElement.type == h &&
                      this.state.callStack.canPop
                    )
                  ...
                  case et.CommandType.EndTag:
                    if (this.state.inStringEvaluation) {
                      for (
                        var g = [],
                          y = 0,
                          C = this.state.outputStream.length - 1;
                        C >= 0;
                        --C
                      ) {
                        ...
                        var w = _(b, et);
                        if (null != w) {
                          if (w.commandType == et.CommandType.BeginTag) break;
                          this.Error(
                      ...
                      var N = new ue(
                        this.state.CleanOutputWhitespace(k.toString())
                      );
                      this.state.PushEvaluationStack(N);
                    } else this.state.PushToOutputStream(l);
                    break;
                  case et.CommandType.EndString:
                    for (
                      var x = [],
                        O = [],
                        I = 0,
                        F = this.state.outputStream.length - 1;
                      F >= 0;
                      --F
                    ) {
                      ...
                      if (R && R.commandType == et.CommandType.BeginString)
                        break;
                      W instanceof ue && O.push(W), W instanceof $ && x.push(W);
                    }
                  ...
                  case et.CommandType.Turns:
                    this.state.PushEvaluationStack(
                      new J(this.state.currentTurnIndex + 1)
                    );
                    break;
                  ...
                  case et.CommandType.ReadCount:
                    ...
                    var ot,
                      st = T(nt, X),
                      lt = _(this.ContentAtPath(st.targetPath).correctObj, tt);
                    null != lt
                      ? (ot =
                          l.commandType == et.CommandType.TurnsSince
                            ? this.state.TurnsSinceForContainer(lt)
                            : this.state.VisitCountForContainer(lt))
                      : ((ot =
                          l.commandType == et.CommandType.TurnsSince ? -1 : 0),
                        this.Warning(
                          "Failed to find container for " +
                            l.toString() +
                            " lookup at " +
                            st.targetPath.toString()
                        )),
                  ...
                  case et.CommandType.Random:
                    ...
                    if (null === ut.value) return L("maxInt.value");
                    if (null === ht.value) return L("minInt.value");
                    var ft = ut.value - ht.value + 1;
                    (!isFinite(ft) || ft > Number.MAX_SAFE_INTEGER) &&
                  ...
                  case et.CommandType.SeedRandom:
                    ...
                    if (null === Ct.value) return L("minInt.value");
                  ...
                  case et.CommandType.ListFromInt:
                    ...
                    var _t = this.listDefinitions.TryListGetDefinition(
                      kt.value,
                      null
                    );
                    if (!_t.exists)
                      throw new G("Failed to find LIST called " + kt.value);
                    if (null === wt.value) return L("minInt.value");
                  ...
                  case et.CommandType.ListRange:
                    ...
                    if (null === Nt.value) return L("targetList.value");
                    var xt = Nt.value.ListWithSubRange(
                      Pt.valueObject,
                      At.valueObject
                    );
                  ...
                  case et.CommandType.ListRandom:
                    ...
                    var It = Ot.value,
                      Wt = null;
                    if (null === It) throw L("list");
                    if (0 == It.Count) Wt = new M();
                    else {
                      for (
                        var Rt =
                      ...
                      var Bt = Vt.next().value,
                        Mt = { Key: B.fromSerializedKey(Bt[0]), Value: Bt[1] };
                      if (null === Mt.Key.originName)
                        return L("randomItem.Key.originName");
                      (Wt = new M(Mt.Key.originName, this)).Add(
                        Mt.Key,
                        Mt.Value
                      ),
              ...
              if (t instanceof pt) {
                ...
                return this.state.variablesState.Assign(Gt, qt), !0;
              }
              if (t instanceof Ft) {
                var Ut = t,
                  Kt = null;
                if (null != Ut.pathForCount) {
                  ...
                  null ==
                    (Kt = this.state.variablesState.GetVariableWithName(
                      Ut.name
                    )) &&
                    (this.Warning(
                      "Variable not found: '" +
                    ...
                    (Kt = new J(0)));
                return this.state.PushEvaluationStack(Kt), !0;
              }
              if (t instanceof it) {
                var zt = t,
                  $t = this.state.PopEvaluationStack(zt.numberOfParameters),
                  Xt = zt.Call($t);
                return this.state.PushEvaluationStack(Xt), !0;
              }
              return !1;
            },
          },
          {
            ...
            value: function (t) {
              ...
              if (
                ...
                this.state.callStack.currentElement.type == ct.Function
              ) {
                var r = "",
                  i =
            ...
            value: function (t) {
              ...
              return (
                ...
                null === n.threadAtGeneration
                  ? L("choiceToChoose.threadAtGeneration")
                  : null === n.targetPath
                  ? L("choiceToChoose.targetPath")
            ...
            value: function (t) {
              ...
              return (
                null != this.onCompleteEvaluateFunction &&
                  this.onCompleteEvaluateFunction(t, e, o, s),
                n ? { returned: s, output: o } : s
              );
            },
          },
          {
          ...
          },
          {
            ...
            value: function () {
              ...
              if (
                (arguments[0] instanceof tt && (t = arguments[0]),
                ...
                if (
                  ...
                  (r += n.size > 1 ? "s" : ""),
                    ...
                    (r += Array.from(n).join("', '")),
                    (r += "' "),
                    (r += this.allowExternalFunctionFallbacks
                ...
                try {
                  for (a.s(); !(i = a.n()).done; ) {
                    ...
                    (null != s && s.hasValidName) ||
                      this.ValidateExternalBindings(o, n);
                  }
                } catch (t) {
                  a.e(t);
                } finally {
            ...
            value: function (t, e) {
              if (
                ...
                if (null != e) {
                  ...
                  var r,
                    i = S(this._variableObservers.keys());
                  try {
                    for (i.s(); !(r = i.n()).done; ) {
                      var a = r.value,
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (null === n) return L("flowContainer");
              for (;;) {
                var r = n.content[0];
                if (!(r instanceof tt)) break;
                n = r;
              }
              var i,
                a = !1,
              ...
              try {
                for (s.s(); !(i = s.n()).done; ) {
                  var l = i.value,
                    u = _(l, et);
                  if (null != u)
                    u.commandType == et.CommandType.BeginTag
                      ? (a = !0)
                      : u.commandType == et.CommandType.EndTag && (a = !1);
                  else {
                    if (!a) break;
                    var c = _(l, $);
                    null !== c
                      ? (null === o && (o = []),
                        null !== c.value && o.push(c.value))
                      : this.Error(
          ...
          },
          {
            ...
            value: function () {
              if (
                ...
                var t = !1;
                this.state.callStack.CanPop(ct.Function)
                  ? (this.state.PopCallStack(ct.Function),
                    this.state.inExpressionEvaluation &&
                      this.state.PushEvaluationStack(new rt()),
                    (t = !0))
                  : this.state.callStack.canPopThread
          ...
          },
          {
            ...
            value: function () {
              ...
              for (; e.index >= e.container.content.length; ) {
                ...
                if (n instanceof tt == !1) break;
                var r = n.content.indexOf(e.container);
                if (-1 == r) break;
                if (
                  ((e = new dt(n, r)).index++, (t = !0), null === e.container)
                )
                  return L("pointer.container");
              }
              return (
          ...
          },
          {
            ...
            value: function () {
              ...
              if (null === e) return L("seqContainer");
              if (null === t.value) return L("numElementsIntVal.value");
              var n = t.value,
                r = T(this.state.PopEvaluationStack(), J).value;
              if (null === r) return L("seqCount");
              for (
                var i = r / n,
                  a = r % n,
                  o = e.path.toString(),
                ...
                s += o.charCodeAt(l) || 0;
              for (
                var c = s + i + this.state.storySeed,
                  h = new pe(Math.floor(c)),
                  f = [],
                  d = 0;
                d < n;
                ++d
      ...
      return (
        ...
        (i.ExportRuntime = function () {
          var e,
            ...
            r =
              arguments.length > 0 && void 0 !== arguments[0]
                ? arguments[0]
                : null;
          (i._errorHandler = r), (i.constants = new Map());
          var a,
            o = S(i.FindAll(_t)());
          try {
            for (o.s(); !(a = o.n()).done; ) {
              ...
              if (l && !l.Equals(s.expression)) {
                var u = "CONST '"
                  .concat(
                    s.constantName,
                    "' has been redefined with a different value. Multiple definitions of the same CONST are valid so long as they contain the same value. Initial definition was on "
                  )
                  .concat(l.debugMetadata, ".");
                i.Error(u, s, !1);
              }
          ...
          try {
            for (f.s(); !(c = f.n()).done; ) {
              var d = c.value;
              (null === (e = d.identifier) || void 0 === e ? void 0 : e.name) &&
                i._listDefs.set(
                  null === (n = d.identifier) || void 0 === n ? void 0 : n.name,
                  d
                );
            }
          } catch (t) {
          ...
          (i.externals = new Map()), i.ResolveWeavePointNaming();
          var v = i.runtimeObject,
            p = new tt();
          p.AddContent(et.EvalStart());
          var g,
            y = [],
            C = S(i.variableDeclarations);
          try {
            for (C.s(); !(g = C.n()).done; ) {
              var b = m(g.value, 2),
                w = b[0],
              ...
              if (k.isGlobalDeclaration) {
                if (k.listDefinition)
                  ...
                  if (!k.expression) throw new Error();
                  k.expression.GenerateIntoContainer(p);
                }
                var E = new pt(w, !0);
                (E.isGlobal = !0), p.AddContent(E);
              }
            }
          } catch (t) {
            C.e(t);
          ...
          p.AddContent(et.EvalEnd()),
            p.AddContent(et.End()),
            i.variableDeclarations.size > 0 &&
              ((p.name = "global decl"), v.AddToNamedContentOnly(p)),
          ...
          return (
            ...
            i.hadError
              ? null
              : (i.FlattenContainersIn(v),
                i.ResolveReferences(h(i)),
                i.hadError ? null : (_.ResetState(), _))
          );
        }),
        ...
        (i.ResolveListItem = function (t, e) {
          var n =
              arguments.length > 2 && void 0 !== arguments[2]
                ...
                : null,
            r = null;
          if (t) return (r = i._listDefs.get(t)) ? r.ItemNamed(e) : null;
          var a,
            o = null,
            s = null,
            l = S(i._listDefs.entries());
          try {
            for (l.s(); !(a = l.n()).done; ) {
              var u = m(a.value, 2),
                c = u[1],
              ...
              h &&
                (o
                  ? i.Error(
                      "Ambiguous item name '"
                        .concat(e, "' found in multiple sets, including ")
                        .concat(s.identifier, " and ")
                        .concat(c.identifier),
                      n,
                      !1
                    )
        ...
        (i.FlattenContainersIn = function (t) {
          ...
          try {
            for (c.s(); !(u = c.n()).done; ) {
              var h = u.value;
              i.TryFlattenContainer(h), i.FlattenContainersIn(h);
            }
          } catch (t) {
            c.e(t);
          } finally {
        ...
        (i.TryFlattenContainer = function (t) {
          if (
            !(
              (t.namedContent && t.namedContent.size > 0) ||
              t.hasValidName ||
              i._dontFlattenContainers.has(t)
            )
          ) {
            var e = _(t.parent, tt);
            if (e) {
        ...
        (i.Error = function (t, e, n) {
          ...
          if (
            (e instanceof W
              ...
              : (a += n ? "WARNING: " : "ERROR: "),
            e &&
              null !== e.debugMetadata &&
              e.debugMetadata.startLineNumber >= 1 &&
              (null != e.debugMetadata.fileName &&
                (a += "'".concat(e.debugMetadata.fileName, "' ")),
        ...
        (i.ResetError = function () {
          (i._hadError = !1), (i._hadWarning = !1);
        }),
        (i.IsExternal = function (t) {
          return i.externals.has(t);
        }),
        (i.AddExternal = function (t) {
          i.externals.has(t.name)
            ? i.Error(
                "Duplicate EXTERNAL definition of '".concat(t.name, "'"),
                t,
                !1
              )
            : t.name && i.externals.set(t.name, t);
        }),
        ...
        (i.NameConflictError = function (t, e, n, r) {
          t.Error(
            ""
              .concat(r, " '")
              .concat(e, "': name has already been used for a ")
              .concat(n.typeName.toLowerCase(), " on ")
              .concat(n.debugMetadata)
          );
        }),
        (i.CheckForNamingCollisions = function (t, e, n) {
          ...
          if (s.IsReservedKeyword(null == e ? void 0 : e.name))
            t.Error(
              "'"
                .concat(e, "' cannot be used for the name of a ")
                .concat(o.toLowerCase(), " because it's a reserved keyword")
            );
          else if (Rt.IsBuiltIn((null == e ? void 0 : e.name) || ""))
            t.Error(
              "'"
                .concat(e, "' cannot be used for the name of a ")
                .concat(o.toLowerCase(), " because it's a built in function")
            );
          else {
            var l = i.ContentWithNameAtLevel(
              ...
              if (!(n < ft.List)) {
                ...
                try {
                  for (h.s(); !(c = h.n()).done; ) {
                    var f = m(c.value, 2),
                      ...
                      v = f[1];
                    if (
                      ((null == e ? void 0 : e.name) === d &&
                        t !== v &&
                        v.variableAssignment !== t &&
                        i.NameConflictError(
                          t,
                          null == e ? void 0 : e.name,
                          v,
                      ...
                      var p,
                        g = S(v.itemDefinitions);
                      try {
                        for (g.s(); !(p = g.n()).done; ) {
                          var y = p.value;
                          (null == e ? void 0 : e.name) === y.name &&
                            i.NameConflictError(
                              t,
                              (null == e ? void 0 : e.name) || "",
                              y,
                ...
                if (!(n <= ft.Var)) {
                  ...
                  if (
                    (C &&
                      C !== t &&
                      C.isGlobalDeclaration &&
                      null == C.listDefinition &&
                      i.NameConflictError(
                        t,
                        (null == e ? void 0 : e.name) || "",
                        C,
                    ...
                    if (w && w !== t)
                      ...
                      var k = _(t, Ot);
                      if ((k || (k = Nt(t)), k && k.hasParameters && k.args)) {
                        var E,
                          T = S(k.args);
                        try {
                          for (T.s(); !(E = T.n()).done; ) {
                            var A = E.value;
                            if (
                              (null === (r = A.identifier) || void 0 === r
                                ? void 0
                                : r.name) === (null == e ? void 0 : e.name)
                            )
                              return void t.Error(
                                ""
                                  .concat(o, " '")
                                  .concat(
                                    e,
                                    "': name has already been used for a argument to "
                                  )
                                  .concat(k.identifier, " on ")
                                  .concat(k.debugMetadata)
                              );
                          }
                        } catch (t) {
                          T.e(t);
            ...
            try {
              for (r.s(); !(e = r.n()).done; ) {
                ...
                if (i instanceof re) {
                  var a = i,
                    l = t.indexOf(i);
                  if ((t.splice(l, 1), a.includedStory)) {
                    var u = [],
                      c = a.includedStory;
                    if (null != c.content) {
                      var h,
        ...
        i(r, [
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return (
                null !== e &&
                !(!this.isSingleString || !e.isSingleString) &&
      ...
      function o(t) {
        ...
        if (
          ...
          (i.CreateDebugMetadata = function (t, e) {
            ...
            return (
              (n.startLineNumber =
                ((null == t ? void 0 : t.lineIndex) || 0) + 1),
              (n.endLineNumber = e.lineIndex + 1),
              (n.startCharacterNumber =
                ((null == t ? void 0 : t.characterInLineIndex) || 0) + 1),
            ...
            if (null !== a) {
              ...
              try {
                for (s.s(); !(o = s.n()).done; ) {
                  var l = o.value;
                  _(l, F) &&
                    (l.hasOwnDebugMetadata ||
                      (l.debugMetadata = i.CreateDebugMetadata(e, n)));
                }
              } catch (t) {
                s.e(t);
              } finally {
          ...
          (i.OnStringParserError = function (t, e) {
            var n =
              ...
              o = a;
            if (
              (null !== i._filename && (o += " '".concat(i._filename, "'")),
          ...
          (i.Choice = function () {
            ...
            if (!e) {
              if (
                null ===
                (e = i.Interleave(
                  i.OptionalExclude(i.Whitespace),
                  i.String("+")
                ))
              )
                return null;
            ...
            if ((i.Whitespace(), i._parsingChoice))
              throw new Error(
            ...
            i.Whitespace(), i.EndTagIfNecessary(null != l ? l : a);
            var f = i.Parse(i.MultiDivert);
            (i._parsingChoice = !1), i.Whitespace();
            var d = !a && !l && !s;
            if (
              (d &&
                null === f &&
          ...
          (i.ParseDashNotArrow = function () {
            var t = i.BeginRule();
            return null === i.ParseString("->") &&
              "-" === i.ParseSingleCharacter()
              ? i.SucceedRule(t)
              : i.FailRule(t);
          }),
          ...
          (i.InnerConditionalContent = function (t) {
            ...
            var r,
              a = null !== t,
              o = null === i.Parse(i.Newline);
            if (o && !a) return null;
            if (o) r = i.InlineConditionalBranches();
            else {
              ...
              if (t)
                for (var c = !1, h = 0; h < r.length; ++h) {
                  var f = r[h],
                    d = h === r.length - 1;
                  f.ownExpression
                    ? ((f.matchingEquality = !0), (c = !0))
                    : c && d
                    ? ((f.matchingEquality = !0), (f.isElse = !0))
                    : !d && r.length > 2
                    ? i.ErrorWithParsedObject(
          ...
          (i.InlineConditionalBranches = function () {
            ...
            if (t.length > 2)
              ...
              var n = new $t(t[0]);
              if (((n.isTrueBranch = !0), e.push(n), t.length > 1)) {
                var r = new $t(t[1]);
                (r.isElse = !0), e.push(r);
              }
            }
          ...
          (i.MultilineConditionalBranches = function () {
            ...
            return null === t ? null : (i.MultilineWhitespace(), t);
          }),
          (i.SingleMultilineCondition = function () {
            ...
            null === t &&
              null === n &&
              (i.Error(
                "expected content for the conditional branch following '-'"
              ),
              (n = [new Et("")])),
              i.MultilineWhitespace();
            var r = new $t(n);
            return (r.ownExpression = t), (r.isElse = e), r;
          }),
          ...
          (i.ElseExpression = function () {
            return null === i.ParseString("else")
              ? null
              : (i.Whitespace(), null === i.ParseString(":") ? null : Ct);
          }),
              ...
              if (r instanceof Et) {
                ...
                (a.text = a.text.replace(new RegExp(/[ \t]+$/g), "")),
                  e
                    ? (a.text += " ")
                    : 0 === a.text.length &&
                      (t.splice(n, 1), i.TrimEndWhitespace(t, !1));
              }
            }
          }),
          (i.LineOfMixedTextAndLogic = function () {
            ...
            return (
              e &&
                e.text &&
                e.text.startsWith("return") &&
                i.Warning(
                  "Do you need a '~' before 'return'? If not, perhaps use a glue: <> (since it's lowercase) or rewrite somehow?"
                ),
              0 === t.length
                ? null
                : (t[t.length - 1] instanceof jt || i.TrimEndWhitespace(t, !1),
                  i.EndTagIfNecessary(t),
                  (t.length > 0 && t[0] instanceof Ee && t[0].isStart) ||
                    t.push(new Et("\n")),
          ...
          (i.MixedTextAndLogic = function () {
            null !== i.ParseObject(i.Spaced(i.String("~"))) &&
              i.Error(
                "You shouldn't use a '~' here - tildas are for logic that's on its own line. To do inline logic, use { curly braces } instead"
              );
            var t = i.Interleave(
              i.Optional(i.ContentText),
              i.Optional(i.InlineLogicOrGlueOrStartTag)
            );
            if (!i._parsingChoice) {
              var e,
                n = i.Parse(i.MultiDivert);
              if (null !== n)
                null === t && (t = []),
                  i.EndTagIfNecessary(t),
          ...
          (i.ContentTextNoEscape = function () {
            null === i._nonTextPauseCharacters &&
              (i._nonTextPauseCharacters = new lt("-<")),
              null === i._nonTextEndCharacters &&
                ((i._nonTextEndCharacters = new lt("{}|\n\r\\#")),
                (i._notTextEndCharactersChoice = new lt(
                  i._nonTextEndCharacters
                )),
                i._notTextEndCharactersChoice.AddCharacters("[]"),
                (i._notTextEndCharactersString = new lt(
                  i._nonTextEndCharacters
                )),
                i._notTextEndCharactersString.AddCharacters('"'));
            var t = null;
            t = i.parsingStringExpression
              ? i._notTextEndCharactersString
              : i._parsingChoice
              ? i._notTextEndCharactersChoice
              : i._nonTextEndCharacters;
            var e = i.ParseUntil(
              function () {
                return i.OneOf([
          ...
          (i.MultiDivert = function () {
            ...
            if (e) return (t = [e]);
            var n = i.Interleave(
              i.ParseDivertArrowOrTunnelOnwards,
              i.DivertIdentifierWithArguments
            );
            if (!n) return null;
            (t = []), i.EndTagIfNecessary(t);
            for (var r = 0; r < n.length; ++r) {
              if (r % 2 == 0) {
                ...
                var s = n[r];
                r < n.length - 1 && (s.isTunnel = !0), t.push(s);
              }
            }
            if (0 === t.length && 1 === n.length) {
              ...
              (l.isEmpty = !0),
                t.push(l),
                i._parsingChoice ||
                  i.Error("Empty diverts (->) are only valid on choices");
            }
            return t;
          }),
          (i.StartThread = function () {
            if ((i.Whitespace(), null === i.ParseThreadArrow())) return null;
            i.Whitespace();
            var t = i.Expect(
              i.DivertIdentifierWithArguments,
          ...
          (i.TempDeclarationOrAssignment = function () {
            ...
            if (
              null ===
              (e = t
                ? i.Expect(i.IdentifierWithMetadata, "variable name")
                : i.Parse(i.IdentifierWithMetadata))
            )
              return null;
            i.Whitespace();
            ...
            if (
              (n && r && i.Error("Unexpected sequence '+-'"),
              null === i.ParseString("="))
            )
              return t && i.Error("Expected '='"), null;
          ...
          (i.ParseTempKeyword = function () {
            var t = i.BeginRule();
            return "temp" === i.Parse(i.Identifier)
              ? (i.SucceedRule(t), !0)
              : (i.FailRule(t), !1);
          }),
          (i.ReturnStatement = function () {
            if ((i.Whitespace(), "return" !== i.Parse(i.Identifier)))
              return null;
            i.Whitespace();
            var t = i.Parse(i.Expression);
            return new Pt(t);
          ...
          (i.Expression = function () {
            ...
            for (
              var r = function () {
                ...
                if (null !== r && r.precedence > t) {
                  ...
                  return null === o
                    ? (i.FailRule(e), { v: null })
                    : ((n = i.SucceedRule(e, o)), "continue");
                }
                return i.FailRule(e), "break";
              };
              ;
            ...
            return i.Whitespace(), n;
          }),
          (i.ExpressionUnary = function () {
            var t = i.Parse(i.ExpressionDivertTarget);
            if (null !== t) return t;
            var e = i.OneOf([i.String("-"), i.String("!")]);
            null === e && (e = i.Parse(i.ExpressionNot)), i.Whitespace();
            var n = i.OneOf([
              i.ExpressionList,
              i.ExpressionParen,
              i.ExpressionFunctionCall,
              i.ExpressionVariableName,
              i.ExpressionLiteral,
            ]);
            if (
              (null === n && null !== e && (n = i.ExpressionUnary()),
              null === n)
            )
              return null;
            null !== e && (n = ot.WithInner(n, e)), i.Whitespace();
            var r = i.OneOf([i.String("++"), i.String("--")]);
            if (null !== r) {
              var a = "++" === r;
              if (n instanceof Wt) n = new ne(n.identifier, a);
              else
                i.Error(
                  "can only increment and decrement variables, but saw '".concat(
                    n,
                    "'."
                  )
                );
          ...
          (i.ExpressionDivertTarget = function () {
            ...
            return !t || (t && t.isThread) ? null : (i.Whitespace(), new Vt(t));
          }),
          ...
          (i.ExpressionString = function () {
            ...
            var t = i.Parse(i.MixedTextAndLogic);
            return (
              i.Expect(i.String('"'), "close quote for string expression"),
          ...
          (i.ExpressionVariableName = function () {
            var t = i.Interleave(
              i.IdentifierWithMetadata,
              i.Exclude(i.Spaced(i.String(".")))
            );
            return null === t || we.IsReservedKeyword(t[0].name)
              ? null
              : new Wt(t);
          }),
          ...
          (i.ExpressionList = function () {
            if ((i.Whitespace(), null === i.ParseString("("))) return null;
            i.Whitespace();
            var t = i.SeparatedList(i.ListMember, i.Spaced(i.String(",")));
            return (
              i.Whitespace(), null === i.ParseString(")") ? null : new oe(t)
            );
          }),
          (i.ListMember = function () {
            ...
            if (null !== i.ParseString(".")) {
              var e = i.Expect(
                i.IdentifierWithMetadata,
                "element name within the set ".concat(t)
              );
              t.name += ".".concat(null == e ? void 0 : e.name);
            }
            return i.Whitespace(), t;
          }),
          ...
          (i.IncludeStatement = function () {
            if ((i.Whitespace(), null === i.ParseString("INCLUDE")))
              return null;
            i.Whitespace();
            ...
            if (i.FilenameIsAlreadyOpen(e))
              return (
                i.Error(
                  "Recursive INCLUDE detected: '".concat(
                    e,
                    "' is already open."
                  )
                ),
            ...
            r &&
              (n = new o(
                r,
                t,
                i._externalErrorHandler,
                i._rootParser,
                i.fileHandler
              ).ParseStory());
            return i.RemoveOpenFilename(e), new re(n);
          }),
          ...
          (i.RemoveOpenFilename = function (t) {
            i._rootParser._openFilenames.splice(
              i._rootParser._openFilenames.indexOf(t),
              1
            );
          }),
          (i.KnotDefinition = function () {
            ...
            var e = i.Expect(
              ...
              i.KnotStitchNoContentRecoveryRule
            );
            return new ae(t.name, e, t.args, t.isFunction);
          }),
          (i.KnotDeclaration = function () {
            if ((i.Whitespace(), null === i.KnotTitleEquals())) return null;
            i.Whitespace();
            var t,
              e = i.Parse(i.IdentifierWithMetadata),
              n = "function" === (null == e ? void 0 : e.name);
            n
              ? (i.Expect(
                  i.Whitespace,
                  "whitespace after the 'function' keyword"
                ),
                (t = i.Parse(i.IdentifierWithMetadata)))
              : (t = e),
              null === t &&
                (i.Error(
                  "Expected the name of the ".concat(n ? "function" : "knot")
                ),
                (t = new xt(""))),
              i.Whitespace();
            var r = i.Parse(i.BracketedKnotDeclArguments);
            return i.Whitespace(), i.Parse(i.KnotTitleEquals), new Qt(t, r, n);
          }),
          ...
          (i.StitchDeclaration = function () {
            ...
            return i.Whitespace(), new Qt(e, n, t);
          }),
          (i.KnotStitchNoContentRecoveryRule = function () {
            return (
              i.ParseUntil(i.KnotDeclaration, new lt("="), null),
          ...
          (i.BracketedKnotDeclArguments = function () {
            if (null === i.ParseString("(")) return null;
            var t = i.Interleave(
              i.Spaced(i.FlowDeclArgument),
              i.Exclude(i.String(","))
            );
            return (
              i.Expect(i.String(")"), "closing ')' for parameter list"),
              null === t && (t = []),
              t
            );
          }),
          (i.FlowDeclArgument = function () {
            ...
            var r = new E();
            return (
              null !== e && (r.isDivertTarget = !0),
              null !== t && "ref" === t.name
                ? (null === n &&
                    i.Error("Expected an parameter name after 'ref'"),
                  (r.identifier = n),
                  (r.isByReference = !0))
                : (r.isDivertTarget ? (r.identifier = n) : (r.identifier = t),
                  null === r.identifier &&
                    i.Error("Expected an parameter name"),
                  (r.isByReference = !1)),
              r
            );
          }),
          (i.ExternalDeclaration = function () {
            i.Whitespace();
            var t = i.Parse(i.IdentifierWithMetadata);
            if (null === t || "EXTERNAL" != t.name) return null;
            i.Whitespace();
            var e =
              i.Expect(i.IdentifierWithMetadata, "name of external function") ||
              new xt("");
            i.Whitespace();
            var n = i.Expect(
              i.BracketedKnotDeclArguments,
              "declaration of arguments for EXTERNAL, even if empty, i.e. 'EXTERNAL ".concat(
                e,
                "()'"
              )
            );
            ...
            var r = n
              .map(function (t) {
                var e;
                return null === (e = t.identifier) || void 0 === e
                  ? void 0
                  : e.name;
              })
              .filter(O);
          ...
          (i.LogicLine = function () {
            ...
            if (null === t) return new It();
            t instanceof nt &&
              !(t instanceof Rt || t instanceof ne) &&
              i.Error(
                "Logic following a '~' can't be that type of expression. It can only be something like:\n\t~ return\n\t~ var x = blah\n\t~ x++\n\t~ myFunction()"
              );
            var e = _(t, Rt);
            return (
              e && (e.shouldPopReturnedValue = !0),
          ...
          (i.VariableDeclaration = function () {
            if ((i.Whitespace(), "VAR" !== i.Parse(i.Identifier))) return null;
            i.Whitespace();
            ...
            if (e) {
              if (
                ...
                e.isSingleString ||
                  i.Error("Constant strings cannot contain any logic.");
              }
              return new Jt({
          ...
          (i.ListDeclaration = function () {
            if ((i.Whitespace(), "LIST" != i.Parse(i.Identifier))) return null;
            i.Whitespace();
            ...
            return e
              ? ((e.identifier = new xt(t.name)),
                new Jt({ variableIdentifier: t, listDef: e }))
              : null;
          }),
          (i.ListDefinition = function () {
            i.AnyWhitespace();
            var t = i.SeparatedList(
              i.ListElementDefinition,
              i.ListElementDefinitionSeparator
            );
          ...
          (i.ListElementDefinition = function () {
            ...
            if (null === n) return null;
            i.Whitespace(),
              t && null != i.ParseString(")") && ((e = !1), i.Whitespace());
            var r = null;
            if (null !== i.ParseString("=")) {
              i.Whitespace();
              var a = i.Expect(
              ...
              null !== a && (r = a.value),
                e && (i.Whitespace(), null !== i.ParseString(")") && (e = !1));
            }
            return e && i.Error("Expected closing ')'"), new se(n, t, r);
          }),
          (i.ConstDeclaration = function () {
            if ((i.Whitespace(), "CONST" !== i.Parse(i.Identifier)))
              return null;
            i.Whitespace();
          ...
          (i.InlineLogic = function () {
            ...
            if (null === n) return (i.parsingStringExpression = t), null;
          ...
          (i.InnerExpression = function () {
            var t = i.Parse(i.Expression);
            return t && (t.outputWhenComplete = !0), t;
          }),
          ...
          (i.SequenceTypeAnnotation = function () {
            ...
            if (
              (null === t && (t = i.Parse(i.SequenceTypeWordAnnotation)),
              null === t)
            )
              return null;
            switch (t) {
              ...
              default:
                return (
                  i.Error(
                    "Sequence type combination not supported: ".concat(t)
                  ),
                  Dt.Stopping
                );
            }
          ...
          (i.SequenceTypeWordAnnotation = function () {
            var t = i.Interleave(
              i.SequenceTypeSingleWord,
              i.Exclude(i.Whitespace)
            );
            if (null === t || 0 === t.length) return null;
            if (null === i.ParseString(":")) return null;
            var e,
          ...
          (i.InnerSequenceObjects = function () {
            return null !== i.Parse(i.Newline)
              ? i.Parse(i.InnerMultilineSequenceObjects)
              : i.Parse(i.InnerInlineSequenceObjects);
          }),
          (i.InnerInlineSequenceObjects = function () {
            var t = i.Interleave(
              i.Optional(i.MixedTextAndLogic),
              i.String("|"),
              null,
              !1
            );
            ...
            try {
              for (a.s(); !(e = a.n()).done; ) {
                var o = e.value;
                if ("|" === o) r || n.push(new It()), (r = !1);
                else {
                  var s = o;
                  null === s
                    ? i.Error(
                        "Expected content, but got ".concat(
                          o,
          ...
          (i.SingleMultilineSequenceElement = function () {
            ...
            return (
              null === t ? i.MultilineWhitespace() : t.unshift(new Et("\n")),
              new It(t)
            );
          }),
          ...
          (i.StatementsAtLevel = function (t) {
            ...
            return i.Interleave(
              i.Optional(i.MultilineWhitespace),
              function () {
          ...
          (i.StatementAtLevel = function (t) {
            ...
            return (
              t === Xt.Top &&
                n instanceof Pt &&
                i.Error("should not have return statement outside of a knot"),
              n
            );
          }),
          ...
          (i.GenerateStatementLevelRules = function () {
            ...
            (i._statementRulesAtLevel = "f"
              .repeat(t.length)
              .split("f")
              .map(function () {
                return [];
              })),
              (i._statementBreakRulesAtLevel = "f"
                .repeat(t.length)
                .split("f")
                .map(function () {
                  return [];
            ...
            for (var e = 0, n = t; e < n.length; e++) {
              ...
              a.push(i.Line(i.MultiDivert)),
                ...
                r <= Xt.InnerBlock &&
                  (o.push(i.ParseDashNotArrow), o.push(i.String("}"))),
          ...
          (i.Line = function (t) {
            return function () {
              ...
              return null === e
                ? null
                : (i.Expect(i.EndOfLine, "end of line", i.SkipToNextLine), e);
            };
          }),
          (i.StartTag = function () {
            if ((i.Whitespace(), null === i.ParseString("#"))) return null;
            i.parsingStringExpression &&
              i.Error(
            ...
            if (i.tagActive) {
              var e = new It();
              e.AddContent(new Ee(!1)), e.AddContent(new Ee(!0)), (t = e);
            } else t = new Ee(!0);
            return (i.tagActive = !0), i.Whitespace(), t;
          }),
          ...
          (i.Newline = function () {
            return i.Whitespace(), null !== i.ParseNewline() ? Ct : null;
          }),
          (i.EndOfFile = function () {
            return i.Whitespace(), i.endOfInput ? Ct : null;
          }),
          ...
          (i.Whitespace = function () {
            return null !==
              i.ParseCharactersFromCharSet(i._inlineWhitespaceChars)
              ? Ct
              : null;
          }),
          (i.Spaced = function (t) {
            return function () {
              i.Whitespace();
              var e = i.ParseObject(t);
              return null === e ? null : (i.Whitespace(), e);
            };
          }),
          (i.AnyWhitespace = function () {
            for (
              var t = !1;
              null !== i.OneOf([i.Whitespace, i.MultilineWhitespace]);
          ...
          (i.MultiSpaced = function (t) {
            return function () {
              i.AnyWhitespace();
              var e = i.ParseObject(t);
              return null === e ? null : (i.AnyWhitespace(), e);
            };
          }),
          (i._filename = null),
        ...
        i(o, [
          {
            key: "fileHandler",
            get: function () {
              if (!this._fileHandler) throw new Error("No FileHandler defined");
          ...
          },
          {
            ...
            get: function () {
              return (
                null === this._identifierCharSet &&
                  ((this._identifierCharSet = new lt())
                    .AddRange("A", "Z")
                    .AddRange("a", "z")
                    .AddRange("0", "9")
                    .Add("_"),
                  this.ExtendIdentifierCharacterRanges(
  ...
  (Te.LatinBasic = ut.Define("A", "z", new lt().AddRange("[", "`"))),
    ...
    (Te.Greek = ut.Define(
      "Ͱ",
      "Ͽ",
      new lt().AddRange("͸", "΅").AddCharacters("ʹ͵͸·΋΍΢")
    )),
    (Te.Cyrillic = ut.Define("Ѐ", "ӿ", new lt().AddRange("҂", "҉"))),
    (Te.Armenian = ut.Define(
      "԰",
      "֏",
      new lt().AddCharacters("԰").AddRange("՗", "ՠ").AddRange("ֈ", "֎")
    )),
  ...
  var Ae = i(function t(e) {
      ...
      n(this, t),
        ...
        (this.ResolveInkFilename = function (t) {
          if (Object.keys(r.fileHierarchy).includes(t)) return t;
          throw new Error(
            "Cannot locate ".concat(
              t,
              ". Are you trying a relative import ? This is not yet implemented."
            )
          );
        }),
        ...
        n(this, t),
          ...
          (this.Compile = function () {
            return (
              (r._parser = new Te(
                r.inputString,
                r.options.sourceFilename || null,
                r.OnError,
                null,
                r.options.fileHandler
              )),
              (r._parsedStory = r.parser.ParseStory()),
              0 === r.errors.length
                ? ((r.parsedStory.countAllVisits = r.options.countAllVisits),
                  (r._runtimeStory = r.parsedStory.ExportRuntime(r.OnError)))
                : (r._runtimeStory = null),
              r.runtimeStory
            );
          }),
          (this.RetrieveDebugSourceForLatestContent = function () {
            var t,
              e,
              n = S(r.runtimeStory.state.outputStream);
            try {
              for (n.s(); !(e = n.n()).done; ) {
                var i = _(e.value, $);
                if (null !== i) {
          ...
          (this.DebugMetadataForContentAtOffset = function (t) {
            var e,
              n = 0,
              i = null,
              a = S(r.debugSourceRanges);
            try {
              for (a.s(); !(e = a.n()).done; ) {
                var o = e.value;
                if (
                  (null !== o.debugMetadata && (i = o.debugMetadata),
                  t >= n && t < n + o.length)
                )
                  return i;
                n += o.length;
      ...
      return (
        i(t, [
          ...
          },
          {
            key: "parsedStory",
            get: function () {
              if (!this._parsedStory) throw new Error();
          ...
          },
          {
            key: "runtimeStory",
            get: function () {
              if (!this._runtimeStory) throw new Error("Compilation failed.");
          ...
          },
          {
            key: "parser",
            get: function () {
              if (!this._parser) throw new Error();
              return this._parser;
            },
          },
          {
